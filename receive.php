...
if(!isset($_SESSION['jzdc']['function'])){
	...
	if(!in_array($target[0].'.'.$target[1],$config['unlogin_function_power']) && !in_array($target[0].'.'.$target[1],$_SESSION['jzdc']['function'])){exit($language['act_noPower']);}	
}
