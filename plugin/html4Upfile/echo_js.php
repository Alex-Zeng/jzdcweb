...
function top_html4_show_succeedList(v,input_id,hiddenValue){
	...
	//jzdc_alert(input_id+"="+document.getElementById(input_id).value);
    path = "/temp/"+hiddenValue.replace("..","");
    v1 = "<a href='"+path+"' target='_blank'><img width='30px' height='30px' src='"+path+"' /> </a>";
	document.getElementById(input_id+"_span").innerHTML=v1;
