    ...
    <script type="text/javascript">
	 ...
	 var input_id;
        function top_html5_UpladFile(input_id,save_dir,dir_append_date,sourceName,top_html5_suffix,max_size,min_size) {
			...
			try{var form = new FormData();}catch(e){jzdc_alert('<?php echo $language['the_browser_does_not_support_this_operation_replace_or_upgrade_your_browser']?>');return false;}
			...
			//jzdc_alert(top_html5_receive_url);
