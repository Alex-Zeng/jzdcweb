...
<div class="page-container" user_color='container'>
   <div class="page-content">
	    <div class="container" m_container="m_container">  
           <div class=row><div class=col-md-3 jzdc_layout="left">
                <?php foreach($modules['left'] as $v){?>
                    <?php $v['object']->$v['method']($v['pdo'],$v['args'])?>
                <?php }?></div><div class=col-md-9 jzdc_layout="right">
...
<!-- END FOOTER -->
     ...
     <p id=set_jzdc_iframe_div>
     	...
     	<iframe  id=jzdc_iframe frameborder=0 src='' scrolling="no" marginwidth=0 marginheight=0 vspace=0 hspace=0 allowtransparency=true></iframe>
    </p>
	</p>
