<div id=<?php echo $module['module_name'];?>  class="portlet light sum_card" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div id=<?php echo $module['module_name'];?>_html>
    	<a href="./index.php?jzdc=mall.order_admin&state=1" class=card_head>
    	...
    	<div class=card_body>
        	<a href='./index.php?jzdc=mall.order_admin&state=0' class=item>
            ...
            </a><a href='./index.php?jzdc=mall.order_admin&state=8' class=item>
            ...
            </a><a href='./index.php?jzdc=mall.order_admin&state=6' class=item>
            ...
            </a><a href='./index.php?jzdc=mall.comment_admin' class=item>
            ...
            </a><a href='./index.php?jzdc=mall.goods_admin&order=inventory|asc' class=item>
            	<span class=name><?php echo self::$language['low_inventory_goods']?></span>
            	<span class=value><?php echo $module['low_inventory'];?></span>
            </a><a href='./index.php?jzdc=mall.goods_admin' class=item>
