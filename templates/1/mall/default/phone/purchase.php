<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div class="portlet-title">
        <div class="caption"><?php echo $module['jzdc_table_name']?> <a href=./index.php?jzdc=mall.purchase_add class=add><?php echo self::$language['pages']['mall.purchase_add']['name']?></a> </div>
    </div>
