<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$(document).on('click', "#<?php echo $module['module_name'];?>  .receiver .content .edit",function() {
			...
			$("#set_jzdc_iframe_div").css('display','block');
			$("#jzdc_iframe").attr('scrolling',"no");
			$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.receiver_edit&buy_method=<?php echo @$_GET['buy_method'];?>&id='+$(this).parent().parent().attr('id').replace(/receiver_/,''));
			return false;	
		});
	...
	#<?php echo $module['module_name'];?>_html .receiver .content .option{ padding:0.3rem;  display: block; width:100%; margin-bottom:2rem;   border: #E4E4E4 solid 1px; text-align:left; line-height:30px;box-shadow: 0px 2px 5px 2px rgba(0, 0, 0, 0.1);}
    ...
    <div id="<?php echo $module['module_name'];?>_html">
         <div class="portlet-title" style="box-shadow: 0px 2px 5px 2px rgba(0, 0, 0, 0.1);  padding-left:0.5rem;">
