<div id=<?php echo $module['module_name'];?> jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$("#<?php echo $module['module_name'];?> .goods_td").click(function(){
			...
			window.location.href='./index.php?jzdc=mall.m_order_detail&id='+id;
			return false;	
		});
		...
		$(document).on('click','#<?php echo $module['module_name'];?> [jzdc-table] .cancel',function(){
			set_iframe_position($(window).width()-100,$(window).height()-200);			//jzdc_alert(replace_file);
	...
	.state_remark a{ display:inline-block; margin-left:0.5rem; padding-left:0.5rem; padding-right:0.5rem; line-height:2rem; border-radius:0.3rem; background:#F60; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
