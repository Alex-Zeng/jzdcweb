<div id=<?php echo $module['module_name'];?>  jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$("#<?php echo $module['module_name'];?> .goods_td").click(function(event){
			if(event.target.tagName!='A'){
				...
				window.location.href='./index.php?jzdc=mall.order_detail&id='+id;
				return false;	
			}
		});
    ...
    <div  class="portlet light" style="background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; padding-bottom:0.5rem;">
    	<div class="portlet-title">
            <div class="caption"><?php echo $module['jzdc_table_name']?></div>
           
    	</div>
    
        <span style="text-align: center">请在PC端管理订单 </span>
