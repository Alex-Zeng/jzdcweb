<div id=<?php echo $module['module_name'];?> jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> [jzdc-table] .del:hover{ }    
    	...
    	<div class=checkout_header>
        	<div class=icon><a href=./index.php  target="_blank"><img src='./program/mall/shop_icon/<?php echo $module['shop_id']?>.png' /></a></div><div class=other>
            	<div class=shop_info>
                    ...
                    <div class="cashier"><?php echo self::$language['cashier'];?>：<a href="./index.php?jzdc=index.user" target="_blank" class=cashier_username><?php echo $module['username']?></a> <a  class="unlogin" id="unlogin" href="./receive.php?target=index::user&act=unlogin"><?php echo self::$language['unlogin_short']?></a></div>
                </div>
                <div class=user_act>
