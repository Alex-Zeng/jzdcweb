<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$('#<?php echo $module['module_name'];?> .edit_c').on('click',function(){
			...
			$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.my_order&id='+$(this).attr('d_id')+'&act='+$(this).attr('act'));
			return false;	
		});
		$("#<?php echo $module['module_name'];?> .add_comment").click(function(){
			...
			$("#fade_div").css('display','block');
			$("#set_jzdc_iframe_div").css('display','block');
			$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.buyer_comment&order_id='+$(this).parent().parent().parent().parent().attr('id').replace(/order_/,'')+'&goods_id='+$(this).parent().parent().parent().attr('goods_id'));
		...
		$("#<?php echo $module['module_name'];?> .comment .edit").on('click',function(){
			...
			$("#fade_div").css('display','block');
			$("#set_jzdc_iframe_div").css('display','block');
			$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.buyer_comment&order_id='+$(this).parent().parent().parent().parent().parent().attr('id').replace(/order_/,'')+'&goods_id='+$(this).parent().parent().parent().parent().attr('goods_id'));
			//alert($("#jzdc_iframe").attr('src'));
			return false;	
		});
    ...
    #<?php echo $module['module_name'];?> .order_div > .title{ white-space:nowrap;   line-height:3rem; height:3rem; overflow:hidden;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
	...
	#<?php echo $module['module_name'];?> [jzdc-table] .filter{ text-align:right; line-height:80px;}
