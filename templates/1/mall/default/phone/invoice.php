<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		if($("#<?php echo $module['module_name'];?> #show_invoice").attr('jzdc_value')==1){
			$("#<?php echo $module['module_name'];?>_html").css('display','block');
		}else{
			$("#<?php echo $module['module_name'];?>_html").css('display','none');
		}
		$("#<?php echo $module['module_name'];?> #show_invoice").prop('value',$("#<?php echo $module['module_name'];?> #show_invoice").attr('jzdc_value'));
    ...
    #<?php echo $module['module_name'];?>_html .sequence{width:50px;}
     ...
     <div class=show_invoice_div><?php echo self::$language['show_invoice'];?><select id=show_invoice jzdc_value="<?php echo $module['show_invoice'];?>" ><option value="0"><?php echo self::$language['no'];?></option><option value="1"><?php echo self::$language['yes'];?></option></select> <span></span></div>
