<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#<?php echo $module['module_name'];?> .limit a[href='./index.php?jzdc=mall.turnover&start_time=<?php echo $_GET['start_time']?>&end_time=<?php echo $_GET['end_time']?>']").attr('class','current');
    ...
    <div id="<?php echo $module['module_name'];?>_html">
        ...
        <div class=money_div>
            ...
            <div class=other_sum>
            	<div class=order><b><?php echo self::$language['order_id']?></b><a href=./index.php?jzdc=mall.order_admin&start_time=<?php echo $_GET['start_time']?>&end_time=<?php echo $_GET['end_time']?> target=_blank><?php echo $module['order_count'];?></a><?php echo self::$language['a']?></div>
            	<div class=goods><b><?php echo self::$language['goods_sold_sum']?></b><a href=./index.php?jzdc=mall.order_admin&start_time=<?php echo $_GET['start_time']?>&end_time=<?php echo $_GET['end_time']?> target=_blank><?php echo $module['goods_count'];?></a><?php echo self::$language['piece']?></div>
