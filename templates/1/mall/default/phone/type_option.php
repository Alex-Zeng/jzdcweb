<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#specifications_source").val($("#specifications_source").attr('jzdc_value'));
	...
	#diy_option_div{ display:none;}
     ...
     <div class=specifications_source_div><?php echo self::$language['specifications_source'];?><select id=specifications_source jzdc_value="<?php echo $module['specifications_source'];?>" ><option value="0"><?php echo self::$language['parent_specifications'];?></option><option value="1"><?php echo self::$language['self_specifications'];?></option></select> <span></span></div>

	<fieldset id="<?php echo $module['module_name'];?>_html"  jzdc-table=1><legend><?php echo self::$language['self_specifications'];?></legend>
