<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    <div id="<?php echo $module['module_name'];?>_html">
        <div class="portlet-title">
            ...
            <div class="actions"><a href=./index.php?jzdc=mall.goods_list&recommendation=1 target="_blank" class=increase  user_color=button><?php echo self::$language['buy_recommendation_goods'];?> <i class="fa fa-angle-double-right"></i></a></div>
        </div>
		<div class=goods_div>
