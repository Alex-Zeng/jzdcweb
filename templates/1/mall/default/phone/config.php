<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	<div id="<?php echo $module['module_name'];?>_html">
        ...
        <div class=line><span class=m_label><?php echo self::$language['cart_show_independent'];?></span><span class=value><select class="cart_show_independent" jzdc_value="<?php echo $module['config']['cart_show_independent']?>" ><option value="1"><?php echo self::$language['yes'];?></option><option value="0"><?php echo self::$language['no'];?></option></select> <span class=state></span></span></div>
        ...
        <div class=line><span class=m_label><?php echo self::$language['show_sold'];?></span><span class=value><select class="show_sold" jzdc_value="<?php echo $module['config']['show_sold']?>" ><option value="true"><?php echo self::$language['yes'];?></option><option value="false"><?php echo self::$language['no'];?></option></select> <span class=state></span></span></div>
		
        <div class=line><span class=m_label><?php echo self::$language['show_comment'];?></span><span class=value><select class="show_comment" jzdc_value="<?php echo $module['config']['show_comment']?>" ><option value="true"><?php echo self::$language['yes'];?></option><option value="false"><?php echo self::$language['no'];?></option></select> <span class=state></span></span></div>
       
        <div class=line><span class=m_label><?php echo self::$language['comment_check'];?></span><span class=value><select class="comment_check" jzdc_value="<?php echo $module['config']['comment_check']?>" ><option value="true"><?php echo self::$language['yes'];?></option><option value="false"><?php echo self::$language['no'];?></option></select> <span class=state></span></span></div>
		
        <div class=line><span class=m_label><?php echo self::$language['goods_check'];?></span><span class=value><select class="goods_check" jzdc_value="<?php echo $module['config']['goods_check']?>" ><option value="0"><?php echo self::$language['yes'];?></option><option value="1"><?php echo self::$language['no'];?></option></select> <span class=state></span></span></div>
		
        <div class=line><span class=m_label><?php echo self::$language['phone_goods_list_show_buy_button'];?></span><span class=value><select class="phone_goods_list_show_buy_button" jzdc_value="<?php echo $module['config']['phone_goods_list_show_buy_button']?>" ><option value="true"><?php echo self::$language['yes'];?></option><option value="false"><?php echo self::$language['no'];?></option></select> <span class=state></span></span></div>
		
        <div class=line><span class=m_label><?php echo self::$language['unlogin_buy'];?></span><span class=value><select class="unlogin_buy" jzdc_value="<?php echo $module['config']['unlogin_buy']?>" ><option value="true"><?php echo self::$language['yes'];?></option><option value="false"><?php echo self::$language['no'];?></option></select> <span class=state></span></span></div>
		
        <div class=line><span class=m_label><?php echo self::$language['agency'];?></span><span class=value><select class="agency" jzdc_value="<?php echo $module['config']['agency']?>" ><option value="true"><?php echo self::$language['yes'];?></option><option value="false"><?php echo self::$language['no'];?></option></select> <span class=state></span></span></div>
        ...
        <div class=line><span class=m_label><?php echo self::$language['near_default'];?></span><span class=value><select class="near_default" jzdc_value="<?php echo $module['config']['near_default']?>" ><?php echo $module['near_option']?></select> <span class=state></span></span></div>
