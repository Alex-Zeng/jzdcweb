<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#<?php echo $module['module_name'];?> .join_goods").val($("#<?php echo $module['module_name'];?> .join_goods").attr('jzdc_value'));
	...
	<div id="<?php echo $module['module_name'];?>_html">
    	<div class=input_line><span class=m_label><?php echo self::$language['join_goods'];?></span><span class=input_span><select class=join_goods jzdc_value="<?php echo $module['data']['join_goods']?>"><option value="1"><?php echo self::$language['join_goods_admin'][1]?></option><option value="0"><?php echo self::$language['join_goods_admin'][0]?></option></select> <span class=state></span></span></div>
