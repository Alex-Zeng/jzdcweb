<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left  style="display:inline-block;width:<?php echo $module['width']?>;height:<?php echo $module['height']?>; ">
	<style>
