<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#attribute_source").val($("#attribute_source").attr('jzdc_value'));
		$("#<?php echo $module['module_name'];?> .list_show").each(function(index, element) {
            if($(this).attr('jzdc_value')==1){$(this).prop('checked',true);}
        });
	...
	.values{width:500px;}
     ...
     <div class=attribute_source_div><?php echo self::$language['attribute_source'];?><select id=attribute_source jzdc_value="<?php echo $module['attribute_source'];?>" ><option value="0"><?php echo self::$language['parent_attribute'];?></option><option value="1"><?php echo self::$language['self_attribute'];?></option></select> <span></span></div>

	<fieldset id="<?php echo $module['module_name'];?>_html"  jzdc-table=1><legend><?php echo self::$language['self_attribute'];?></legend>
