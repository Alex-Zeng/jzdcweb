...
$(document).ready(function(){
	...
	$("#<?php echo $module['module_name'];?> .goods_filter li a").click(function(){
		window.location.href='./index.php?jzdc=mall.checkout_search'+$(this).attr('data');
...
　　　});	
	...
	$("#<?php echo $module['module_name'];?> .search").keyup(function(event){
		...
		if(event.keyCode==13 && $(this).val()!=''){
			window.location.href='./index.php?jzdc=mall.checkout_search&search='+$(this).val();
		}
	});
	$("#<?php echo $module['module_name'];?> .search_div .submit").click(function(){
		window.location.href='./index.php?jzdc=mall.checkout_search&search='+$("#<?php echo $module['module_name'];?> .search").val();
		return false;
	});
...
<script>
function jzdc_page_go(v){return false;}
</script>
</div>
</div>