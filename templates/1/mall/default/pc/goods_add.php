<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left  >
		...
		if(''=='<?php echo @$_POST['option_type'];?>'){
		  ...
		  //if(inventory.prop('value')==''){inventory.next().html('<span class=fail><?php echo self::$language['please_input']?></span>');inventory.focus();return false;}
			...
			$("#<?php echo $module['module_name'];?> #option_table tbody tr").each(function(index, element) {
				if($(this).css('display')!='none'){
					//alert($(this).attr('id'));
					obj['specifications'][$(this).attr('id')]='quantity===10000,,,cost_price==='+$(this).children('td').children('.cost_price').val()+',,,e_price==='+$(this).children('td').children('.e_price').val()+',,,w_price==='+$(this).children('td').children('.w_price').val()+',,,barcode==='+$(this).children('td').children('.bar_code').val()+',,,store_code==='+$(this).children('td').children('.store_code').val();
				}
            });
    ...
    <form id="jzdc_form" name="jzdc_form" method="POST" action="<?php echo $module['action_url'];?>" onSubmit="return exe_check();">
      ...
      <?php echo $module['unit'];?></select><input type="text" class="hide_input" /> <span class=state></span><a href="#" class=switch_input>&nbsp;</a>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span><input type="hidden" id="tag" name="tag" /><?php echo $module['tags'];?>  <span class=state></span><a href="index.php?jzdc=mall.s_tag" class=create target="_blank"><?php echo self::$language['create']?></a>
            </span>
        </div>
        -->
    	<div class=line_div>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="goods_state" name="goods_state" jzdc_value="2"><?php echo $module['goods_state']?></select> <span class=state></span>
            </span>
        </div>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="limit" name="limit" jzdc_value="0"><?php echo $module['buy_limit_option']?></select> <span class=state></span>
            </span>
        </div>
		    
    	<div class=line_div d="buy_limit" style="display:none;">
        	<span class=m_label><?php echo self::$language['buy_limit_cycle'];?></span>
        	<span class=input_span><select id="limit_cycle" name="limit_cycle" jzdc_value="d"><?php echo $module['limit_cycle_option']?></select> <span class=state></span></span>
        </div>
    ...
    <ul class="nav nav-tabs" device_tabs=1>
      <li role="presentation" class="active"><a href="#" target="m_detail_div"><?php echo self::$language['goods'];?><?php echo self::$language['detail'];?></a></li>
		...
		<div class="detail_div" style="display:none;"><textarea name="detail" id="detail" style="display:none; width:100%; height:400px;"></textarea></div>
        <div class="m_detail_div" ><textarea name="m_detail" id="m_detail" style="display:none; width:100%; height:400px;"></textarea></div>
