<div id=<?php echo $module['module_name'];?> jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> [jzdc-table] tbody tr{ line-height:30px; height:30px;}
	#<?php echo $module['module_name'];?> [jzdc-table] .even td{ line-height:30px; height:30px;}
	#<?php echo $module['module_name'];?> [jzdc-table] .odd td{ line-height:30px; height:30px;}
    #<?php echo $module['module_name'];?> [jzdc-table] input{ width:80px;}
    #<?php echo $module['module_name'];?> [jzdc-table] .expiration{ width:140px;}
    #<?php echo $module['module_name'];?> [jzdc-table] .payment{ width:50px;}
    </style>
