<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .buyer .point:after{ color:#F90; font: normal normal normal 1rem/1 FontAwesome; content:"\f0d9"; color:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['background']?>;}
    #<?php echo $module['module_name'];?> .buyer .content{ line-height:25px; display:inline-block; vertical-align:top; padding-left:10px;  padding-right:10px; border-radius:5px; font-size:1rem;background:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['text']?>;}
