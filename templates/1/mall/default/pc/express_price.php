<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div class=area_a><?php echo self::$language['area_s']?>:<a href=./index.php?jzdc=mall.express_price&id=<?php echo $_GET['id']?>><?php echo  self::$language['all']?></a><?php echo $module['area_a_position'];?></div>
