<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	<div style="text-align:right;"><a class=submit href=./index.php?jzdc=mall.interest_group&act=synchronization><?php echo self::$language['synchronization']?><?php echo self::$language['type']?></a></div>
