<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	[jzdc-table] .module_list{ display:inline-block;width:650px; overflow:hidden; text-align:right;}
	[jzdc-table] .module_list input{ display:inline-block;width:530px; margin-left:5px; overflow:hidden; margin:5px;}
