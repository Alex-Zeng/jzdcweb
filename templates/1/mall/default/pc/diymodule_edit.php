<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    function exe_check(){
        ...
        if(title.prop('value')==''){jzdc_alert('<?php echo self::$language['please_input']?><?php echo self::$language['name']?>');title.focus();return false;}
        if(width.prop('value')==''){jzdc_alert('<?php echo self::$language['please_input']?><?php echo self::$language['module_width']?>');width.focus();return false;}
        if(height.prop('value')==''){jzdc_alert('<?php echo self::$language['please_input']?><?php echo self::$language['module_height']?>');height.focus();return false;}
    ...
    <form id="jzdc_form" name="jzdc_form" method="POST" action="<?php echo $module['action_url'];?>&id=<?php echo $_GET['id']?>" onSubmit="return exe_check();">
