	...
	function exe_stocktake_submit(){
		...
		$.post('<?php echo $module['action_url'];?>&act=update',{id:$("#<?php echo $module['module_name'];?> .id").val(),quantity:$("#<?php echo $module['module_name'];?> .quantity").val()}, function(data){
			...
			if(v.state=='success'){
				...
				$("#<?php echo $module['module_name'];?> .bar_code").val('');
				$("#<?php echo $module['module_name'];?> .bar_code").focus();
				$("#<?php echo $module['module_name'];?> .success_state").html(v.info+' <a href=./index.php?jzdc=mall.stocktake_list&stocktake_id=<?php echo $_GET['stocktake_id']?>><?php echo self::$language['view'];?></a>');
				/*				
				...
				$("#<?php echo $module['module_name'];?> .goods_info").css("display",'none');
				$("#<?php echo $module['module_name'];?> .bar_code").next('.state').html(v.info+' <a href=./index.php?jzdc=mall.stocktake_list&stocktake_id=<?php echo @$_GET['stocktake_id']?>><?php echo self::$language['return'];?></a>');
				*/
			}
		});
	}
