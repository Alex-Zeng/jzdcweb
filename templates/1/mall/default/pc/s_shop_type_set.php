<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#<?php echo $module['module_name'];?> #shop_type").val($("#<?php echo $module['module_name'];?> #shop_type").attr('jzdc_value'));
    ...
    <?php echo self::$language['belong']?><?php echo self::$language['store']?><?php echo self::$language['type']?><select id=shop_type name=shop_type jzdc_value=<?php echo @$_GET['id']?> ><?php echo $module['type_option']?></select>  <a href=# class=submit><?php echo self::$language['submit'];?></a> <span></span>
    </div>
