<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?> .process{ margin-bottom:20px; background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
    ...
    #<?php echo $module['module_name'];?> .process span b{   width:30px; height:30px; margin-top:10px; margin-right:5px; line-height:30px; display:inline-block; border-radius:15px; overflow:hidden ; background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
