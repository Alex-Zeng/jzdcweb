...
<script>
	...
	$("#<?php echo $module['module_name'];?> .search_result_div").css('top',$("#<?php echo $module['module_name'];?> .barcode").offset().top+30).css('left',$("#<?php echo $module['module_name'];?> .barcode").offset().left);
		...
		$("#<?php echo $module['module_name'];?> .table_scroll .goods_info").click(function(){
			...
			$("#fade_div").css('display','block');
			$("#set_jzdc_iframe_div").css('display','block');
			$("#jzdc_iframe").attr('src',$(this).attr('href')+'#mall_goods');
			$("#<?php echo $module['module_name'];?> .barcode").val('');
			return false;	
		});
		...
		$(document).on('click',"#<?php echo $module['module_name'];?> .pay_method a",function(){
			...
			if($(this).attr('value')=='alipay' || $(this).attr('value')=='weixin'){
				...
				$("#fade_div").css('display','block');
				$("#set_jzdc_iframe_div").css('display','block');
				$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.checkout_search&act=scanpay&id='+$(this).attr('account_id')+'&user='+$("#<?php echo $module['module_name'];?> .user").val()+'&money='+$("#<?php echo $module['module_name'];?> #amount_payable_line .number").html());
				return false;
			}
	...
	#<?php echo $module['module_name'];?> .checkout_header{  position:fixed; top:0px;left:0px; width:100%; height:6rem; background-color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['text']?>; color:#FFF; border-bottom:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?> solid 0.3rem; z-index:9999;}
	...
	#<?php echo $module['module_name'];?> .type_list_div{ display:inline-block; vertical-align:top; width:8%; height:100%; overflow:hidden;white-space:normal;background-color:<?php echo $_POST['jzdc_user_color_set']['nv_2']['background']?>; color:#FFF;}
	...
	.pay_method a:hover{ background:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['text']?>;}
	.pay_method .disable{ opacity:0.4;}
	.pay_method .disable:hover{background:none; color:#000;}
	.pay_method .selected{background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?> !important;}
...
user-select: none;}
	...
	.touch_keyboard .number_div a{ background:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['text']?>;display: inline-block; vertical-align:top; width:29%; margin:2%; height:5rem; line-height:5rem; text-align:center; border-radius:3px; font-size:1.2rem; cursor:pointer;}
	.touch_keyboard .number_div a:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
