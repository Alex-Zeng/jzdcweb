<div id=<?php echo $module['module_name'];?>  class="portlet light"  jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$("#<?php echo $module['module_name'];?> .supplier").val($("#<?php echo $module['module_name'];?> .supplier").attr('jzdc_value'));
		$("#<?php echo $module['module_name'];?> .supplier").val($("#<?php echo $module['module_name'];?> .supplier").attr('jzdc_value'));
	...
	function exe_purchase_add(){
		...
		$.post('<?php echo $module['action_url'];?>&act=add',{id:$("#<?php echo $module['module_name'];?> .id").val(),option_id:$("#<?php echo $module['module_name'];?> #option_id").val(),supplier:$("#<?php echo $module['module_name'];?> .supplier").val(),quantity:$("#<?php echo $module['module_name'];?> .quantity").val(),price:$("#<?php echo $module['module_name'];?> .price").val(),production_date:$("#<?php echo $module['module_name'];?> .production_date").val(),shelf_life:$("#<?php echo $module['module_name'];?> .shelf_life").val(),payment:$("#<?php echo $module['module_name'];?> .payment").val()}, function(data){
			...
			if(v.state=='success'){
				...
				$("#<?php echo $module['module_name'];?> .success_state").html(v.info+' <a href=./index.php?jzdc=mall.purchase><?php echo self::$language['view'];?></a>');
			}
		});
	}
	...
	#<?php echo $module['module_name'];?> .re_list a{ display: block; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
    ...
    <div id="<?php echo $module['module_name'];?>_html"  jzdc-table=1>
    	...
    	<div class=line id=bar_code_div><span class=m_label><?php echo self::$language['bar_code']?>/<?php echo self::$language['store_code']?>:</span><span class=m_value><input type="text" class=bar_code id=bar_code_input /> <span class=state></span> <a href=./index.php?jzdc=mall.stock class=or_link_into><?php echo self::$language['or_link_into']?></a></span></div>
