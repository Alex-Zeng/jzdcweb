<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    $(document).ready(function(){
		$("#<?php echo $module['module_name'];?> #talk_type").val($("#<?php echo $module['module_name'];?> #talk_type").attr('jzdc_value'));
		$("#<?php echo $module['module_name'];?> #barcode_repeat").val($("#<?php echo $module['module_name'];?> #barcode_repeat").attr('jzdc_value'));
		$("#<?php echo $module['module_name'];?> #circle").val($("#<?php echo $module['module_name'];?> #circle").attr('jzdc_value'));
		...
		$("#<?php echo $module['module_name'];?> #template").val($("#<?php echo $module['module_name'];?> #template").attr('jzdc_value'));
		...
		$("#<?php echo $module['module_name'];?>_html .submit").click(function(){
			...
			$("#<?php echo $module['module_name'];?>_html input").each(function(index, element) {
				if($(this).attr('id')!='self_certificate_file' && $(this).attr('id')!='head' && $(this).attr('id')!='certificate_file' && $(this).attr('id')!='icon_file' && $(this).attr('id')!='ticket_logo_file'){
					if($(this).prop('value')==''){
    ...
    <div id="<?php echo $module['module_name'];?>_html">
    	...
    	<div class=line><span class=m_label><?php echo self::$language['shop_style'];?></span><span class=input_span><select id=template name=template jzdc_value="<?php echo $module['template']?>"><?php echo $module['template_option']?></select> <span class=state></span></span></div>
    ...
    <span id="home_area_state" ></span>
    	...
    	<div class=line><span class=m_label><?php echo self::$language['circle'];?></span><span class=input_span><select id="circle" name="circle" jzdc_value="<?php echo $module['circle']?>"><option value=""><?php echo self::$language['please_select']?></option><?php echo $module['circle_option']?></select> <span class=state></span></span></div>
    	...
    	<div class=line><span class=m_label><?php echo self::$language['in_position'];?></span><span class=input_span><input type="text" id="position" name="position" jzdc_type="map" value="<?php echo $module['position'];?>"  /> <span class=state></span></span></div>
        
    	<div class=line><span class=m_label><?php echo self::$language['online_talk'];?></span><span class=input_span><select type="text" id="talk_type" name="talk_type" jzdc_value="<?php echo $module['talk_type']?>" ><?php echo $module['talk_option']?></select> <input type="text" id="talk_account" name="talk_account" value="<?php echo $module['talk_account'];?>"  /> <span class=state></span></span></div>
    	...
    	<div class=line><span class=m_label><?php echo self::$language['barcode_repeat'];?></span><span class=input_span><select id="barcode_repeat" name="barcode_repeat" jzdc_value="<?php echo $module['barcode_repeat']?>"><option value="0"><?php echo self::$language['no']?></option><option value="1"><?php echo self::$language['yes']?></option></select> <span class=state></span></span></div>
