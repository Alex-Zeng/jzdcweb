<div id=<?php echo $module['module_name'];?> jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$(document).on('click',"#<?php echo $module['module_name'];?> [jzdc-table] .operation_td .del", function() {
		...
		$(document).on('click','#<?php echo $module['module_name'];?> [jzdc-table] .cancel',function(){
			...
			$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.order_cancel&id='+$(this).attr('d_id'));
			return false;	
		});
		
		$(document).on('click','#<?php echo $module['module_name'];?> [jzdc-table] .apply_refund',function(){
			set_iframe_position(1000,500);
			//jzdc_alert(replace_file);
			$("#jzdc_iframe").attr('scrolling','auto');
			$("#fade_div").css('display','block');
			$("#set_jzdc_iframe_div").css('display','block');
			$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.apply_refund&id='+$(this).attr('d_id'));
			return false;	
		});
		
		$(document).on('click','#<?php echo $module['module_name'];?> [jzdc-table] .upload_refund_voucher',function(){
			set_iframe_position(1000,500);
			//jzdc_alert(replace_file);
			$("#jzdc_iframe").attr('scrolling','auto');
			$("#fade_div").css('display','block');
			$("#set_jzdc_iframe_div").css('display','block');
			$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.refund_express_voucher&id='+$(this).attr('d_id'));
			return false;	
		});
		...
		$(document).on('click',"#<?php echo $module['module_name'];?> [jzdc-table] .undo_refund", function() {
  			id=$(this).attr('d_id');
		...
		$("#<?php echo $module['module_name'];?> .add_comment").click(function(){
			...
			$("#fade_div").css('display','block');
			$("#set_jzdc_iframe_div").css('display','block');
			$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.buyer_comment&order_id='+$(this).parent().parent().parent().parent().parent().parent().attr('id').replace(/tr_/,'')+'&goods_id='+$(this).parent().parent().parent().attr('goods_id'));
		...
		$(document).on('click',"#<?php echo $module['module_name'];?> .comment .edit",function(){
			...
			$("#fade_div").css('display','block');
			$("#set_jzdc_iframe_div").css('display','block');
			$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.buyer_comment&order_id='+$(this).parent().parent().parent().parent().parent().parent().parent().attr('id').replace(/tr_/,'')+'&goods_id='+$(this).parent().parent().parent().parent().attr('goods_id'));
			//alert($("#jzdc_iframe").attr('src'));
			return false;	
		});
    ...
    #<?php echo $module['module_name'];?> [jzdc-table] .filter{ line-height:50px;}
	...
	#<?php echo $module['module_name'];?> .goods_info .goods .comment .user:before{margin-right:8px; color:#F90; font: normal normal normal 1rem/1 FontAwesome; content:"\f0da";color:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['background']?>;}
	#<?php echo $module['module_name'];?> .goods_info .goods .comment .content{display:inline-block; white-space:normal; text-align:left; padding-left:10px;  padding-right:10px; border-radius:5px; background:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['text']?>; font-size:1rem;  max-width:70%;}
	...
	#<?php echo $module['module_name'];?> .goods_info .goods .comment .content .edit:before{margin-left:8px; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; font: normal normal normal 1rem/1 FontAwesome; content:"\f040";}
	#<?php echo $module['module_name'];?> .goods_info .goods .comment .content .del:before{margin-left:8px; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; font: normal normal normal 1rem/1 FontAwesome; content:"\f014";}
