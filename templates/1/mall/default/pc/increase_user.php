			...
			if($("#<?php echo $module['module_name'];?> .username").val()!=''){
				...
				$.post('<?php echo $module['action_url'];?>&act=add_exist',{username: $("#<?php echo $module['module_name'];?> .username").val()}, function(data){
					...
					if(v.state=='success'){
						...
						$("#<?php echo $module['module_name'];?> .username").next().html('<span class=success><?php echo self::$language['success']?></span> <a href=./index.php?jzdc=mall.my_buyer&search='+$("#<?php echo $module['module_name'];?> .username").val()+'><?php echo self::$language['view']?></a>');
					}else{
        ...
        $("#<?php echo $module['module_name'];?> .submit").click(function(){
			...
			$.post('<?php echo $module['action_url'];?>&act=add',obj, function(data){
				...
				if(v.state=='success'){
					...
					$("#<?php echo $module['module_name'];?> .submit").next().html(v.info+' <a href=./index.php?jzdc=mall.my_buyer&search='+$("#<?php echo $module['module_name'];?> .username").val()+'><?php echo self::$language['view']?></a>');
				}
