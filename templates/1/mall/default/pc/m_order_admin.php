<div id=<?php echo $module['module_name'];?>  jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$(document).on('click','#<?php echo $module['module_name'];?>  .view_apply',function(){
			...
			$("#jzdc_iframe").attr('src','./index.php?jzdc=mall.m_view_refund&id='+$(this).attr('d_id'));
			return false;	
		});
	...
	#<?php echo $module['module_name'];?> .title_tr .buyer_address{padding-left:10px; font-size:14px; height:2.2rem; line-height:2.2rem;  background: #EFEFEF; color:#999;}
	...
	#<?php echo $module['module_name'];?> .goods_info .goods .comment .content{background: #F90; display:inline-block; padding-left:10px;  padding-right:10px; border-radius:5px; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; font-size:14px;  max-width:70%;}
