<div id=<?php echo $module['module_name'];?>  jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	function inquiry_check_code(){
		...
		window.location.href='./index.php?jzdc=mall.check_code&check_code_state=1&check_code='+$("#<?php echo $module['module_name'];?> #check_code").val();
	}
    ...
    <div  class="portlet light" >
      ...
      <li role="presentation"><a check_code_state=1 href="./index.php?jzdc=mall.check_code&check_code_state=1"><?php echo self::$language['check_code_option'][1]?></a></li>
      <li role="presentation"><a check_code_state=2  href="./index.php?jzdc=mall.check_code&check_code_state=2"><?php echo self::$language['check_code_option'][2]?></a></li>
            ...
            <div class="actions">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#" href_pre="./index.php?jzdc=mall.order_print" class="print_order" target="_blank"><?php echo self::$language['print_order']?></a></li>
                        <li><a href="#" href_pre="./index.php?jzdc=mall.order_print_list" class="order_print_list" target="_blank"><?php echo self::$language['pages']['mall.order_print_list']['name']?></a></li>
                        <li><a href="#" href_pre="./index.php?jzdc=mall.express_print" class="express_print" target="_blank"><?php echo self::$language['express_print']?></a></li>
                    </ul>
                </div>
            </div>
    	</div>
