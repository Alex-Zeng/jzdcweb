<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		if('stock_big'=='<?php echo @$_GET['act'];?>'){
			$("[jzdc-table] tbody tr").each(function(index, element) {
				$(this).children('.operation_td').html("<a href='./index.php?jzdc=mall.public_stock&act=big&ps_id=<?php echo @$_GET['ps_id']?>&goods_id="+$(this).attr('id').replace(/tr_/,'')+"' class=recommendation><?php echo self::$language['setting']?><?php echo self::$language['stock_big']?></a><br />");

            });	
		}
		if('stock_small'=='<?php echo @$_GET['act'];?>'){
			$("[jzdc-table] tbody tr").each(function(index, element) {
				$(this).children('.operation_td').html("<a href='./index.php?jzdc=mall.public_stock&act=small&ps_id=<?php echo @$_GET['ps_id']?>&goods_id="+$(this).attr('id').replace(/tr_/,'')+"' class=recommendation><?php echo self::$language['setting']?><?php echo self::$language['stock_small']?></a><br />");

            });	
		}
		if('agency'=='<?php echo @$_GET['act'];?>'){
			$("[jzdc-table] tbody tr").each(function(index, element) {
				$(this).children('.operation_td').html("<a href='./index.php?jzdc=agency.shop_goods&goods_id="+$(this).attr('id').replace(/tr_/,'')+"' class=recommendation><?php echo self::$language['set_agency']?></a><br />");

            });	
		}
		if('recommendation'=='<?php echo @$_GET['act'];?>'){
			$("[jzdc-table] tbody tr").each(function(index, element) {
				$(this).children('.operation_td').html("<a href='./index.php?jzdc=mall.recommendation_set&goods_id="+$(this).attr('id').replace(/tr_/,'')+"' class=recommendation><?php echo self::$language['support_recommendation']?></a><br />");
		...
		if('relevance_goods'=='<?php echo @$_GET['act'];?>'){
			$("[jzdc-table] tbody tr").each(function(index, element) {
				if($(this).attr('id')=='tr_<?php echo @$_GET['goods_id']?>'){
					...
					$(this).children('.operation_td').html('<a href="index.php?jzdc=mall.relevance_goods&goods_id=<?php echo @$_GET['goods_id']?>&relevance_new='+$(this).attr('id').replace(/tr_/,'')+'" class=relevance><?php echo self::$language['relevance'];?></a>');
		...
		if('relevance_package'=='<?php echo @$_GET['act'];?>'){
			if(''=='<?php echo  @$_GET['goods_ids'];?>'){
				$("[jzdc-table] tbody tr").each(function(index, element) {
					$(this).children('.operation_td').html('<a href="index.php?jzdc=mall.package_admin&package_id=<?php echo @$_GET['package_id']?>&relevance_new='+$(this).attr('id').replace(/tr_/,'')+'" class=relevance><?php echo self::$language['add_to_package'];?></a>');
				});	
			}else{
    ...
    function print_shelf_label(){
		...
		$("#state_select").html('');
		window.location.href='./index.php?jzdc=mall.shelf_label&ids='+ids;
		return false;
	}
	...
	#<?php echo $module['module_name'];?> [jzdc-table] thead tr td{ white-space:nowrap;}
    ...
    <div class="portlet-title">
        ...
        <div class="actions">
  &nbsp; &nbsp; <a href="index.php?jzdc=mall.goods_add" target="_blank" class="add"><?php echo self::$language['add']?><?php echo self::$language['goods'];?></a>
  &nbsp; &nbsp;<!--
            <a href="index.php?jzdc=mall.batch_reset_price" ><?php echo self::$language['pages']['mall.batch_reset_price']['name'];?></a>
            <a href="index.php?jzdc=mall.goods_in_out" ><?php echo self::$language['bulk']?><?php echo self::$language['pages']['mall.goods_in_out']['name'];?></a>
       ...
       &nbsp; &nbsp; <a href="./index.php?jzdc=mall.shelf_label" target="_blank" class="export"><?php echo self::$language['print_shelf_label'];?>(<?php echo self::$language['all']?>)</a>          
           -->
