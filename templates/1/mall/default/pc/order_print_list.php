<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .order_div .order_body .goods .goods_id{ width:12%; overflow:hidden;}
	#<?php echo $module['module_name'];?> .order_div .order_body .goods .goods_name{ width:64%; overflow:hidden;}
	#<?php echo $module['module_name'];?> .order_div .order_body .goods .goods_price{ width:8%; overflow:hidden;}
