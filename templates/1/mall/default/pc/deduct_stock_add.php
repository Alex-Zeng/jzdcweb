<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	function exe_purchase_add(){
		...
		$.post('<?php echo $module['action_url'];?>&act=add',{id:$("#<?php echo $module['module_name'];?> .id").val(),option_id:$("#<?php echo $module['module_name'];?> #option_id").val(),supplier:$("#<?php echo $module['module_name'];?> .supplier").val(),quantity:$("#<?php echo $module['module_name'];?> .quantity").val(),reason:$("#<?php echo $module['module_name'];?> .reason_text").val()}, function(data){
			...
			if(v.state=='success'){
				...
				$("#<?php echo $module['module_name'];?> .submit").next('.state').html(v.info+' <a href=./index.php?jzdc=mall.deduct_stock><?php echo self::$language['view'];?></a>');
			}
		});
	}
    ...
    <div id="<?php echo $module['module_name'];?>_html"  jzdc-table=1>
    	...
    	<div class=line id=bar_code_div><span class=m_label><?php echo self::$language['bar_code']?>:</span><span class=m_value><input type="text" class=bar_code  /> <span class=state></span> <a href=./index.php?jzdc=mall.stock class=or_link_into><?php echo self::$language['or_link_into']?></a></span></div>
