<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    $(document).ready(function(){
		...
		$("[jzdc_value]").each(function(index, element) {
		...
		$("#<?php echo $module['module_name'];?> select").each(function(index, element) {
            if($(this).attr('jzdc_value')){$(this).prop('value',$(this).attr('jzdc_value'));}
        });
			...
			if(''!='<?php echo @$_POST['option_color']?>'){
				if(''=='<?php echo @$_POST['option_option']?>'){
					$("#<?php echo $module['module_name'];?> #color_div .color_span").each(function(index, element) {
						...
						option_html+='<tr class='+t_id+' id=specifications_'+t_id+'><td>'+$(this).children('m_label').html()+'</td><td><input type=text class=cost_price /></td><td><input type=text class=e_price /></td><td><input type=text class=w_price /></td><td><input type=text class=bar_code  maxlength="13" /><img class=s_bar_code_img /></td><td><input type=text class=store_code  maxlength="13" /><img class=s_store_code_img /></td><td><a href=# class=del><?php echo self::$language['del']?></a><a href=# class=batch_write><?php echo self::$language['batch_write']?></a> <span class=state>&nbsp;</span></td></tr>';
					});
    ...
    function goods_submit(){
		...
		if(''=='<?php echo @$_POST['option_type'];?>'){
		  ...
		  //if(inventory.prop('value')==''){inventory.next().html('<span class=fail><?php echo self::$language['please_input']?></span>');inventory.focus();return false;}
			...
			obj['e_price']=$("#<?php echo $module['module_name'];?> #w_price").val();
		  ...
		  //if(!$.isNumeric(obj['bar_code']) && obj['bar_code']!=''){$("#<?php echo $module['module_name'];?> #bar_code").next().html('<span class=fail><?php echo self::$language['must_be']?><?php echo self::$language['number']?></span>');$("#<?php echo $module['module_name'];?> #bar_code").focus();return false;}
			...
			$("#<?php echo $module['module_name'];?> #option_table tbody tr").each(function(index, element) {
				if($(this).css('display')!='none'){
					//alert($(this).attr('id'));
					obj['specifications'][$(this).attr('id')]='quantity===1000000,,,cost_price==='+$(this).children('td').children('.cost_price').val()+',,,e_price==='+$(this).children('td').children('.e_price').val()+',,,w_price==='+$(this).children('td').children('.w_price').val()+',,,barcode==='+$(this).children('td').children('.bar_code').val()+',,,store_code==='+$(this).children('td').children('.store_code').val();
    ...
    <form id="jzdc_form" name="jzdc_form" method="POST" action="<?php echo $module['action_url'];?>" onSubmit="return exe_check();">
    	<div class=line_div>
        	...
        	<span class=input_span><?php echo $module['type']?><span class=state></span> <a href="./index.php?jzdc=mall.goods_add_option_type&act=edit&id=<?php echo $_GET['type'];?>&goods_id=<?php echo $_GET['id'];?>" class="edit"><?php echo self::$language['edit'];?></a></span>
        </div>
<!--
    	<div class=line_div>
        	...
        	<span class=input_span><select id=shop_type name=shop_type jzdc_value='<?php echo $module['data']['shop_type'];?>'><option value=0>&nbsp;</option><?php echo $module['shop_type']?></select><input type="text" class="hide_input" /> <span class=state></span><a href="#" class=switch_input>&nbsp;</a>
            </span>
        </div>
    	<div class=line_div>
        	<span class=m_label><?php echo self::$language['brand'];?></span>
        	<span class=input_span>
            	<select id="brand" name="brand" jzdc_value='<?php echo $module['data']['brand'];?>'>
      ...
      <?php echo $module['brand_option'];?></select><input type="text" class="hide_input" /> <span class=state></span><a href="#" class=switch_input>&nbsp;</a>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="grade" name="grade" jzdc_value='<?php echo $module['data']['grade'];?>'>
      <option value="-1">&nbsp;</option> 
      <?php echo $module['grade_option'];?></select><input type="text" class="hide_input" /> <span class=state></span><a href="#" class=switch_input>&nbsp;</a>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="habitat" name="habitat" jzdc_value='<?php echo $module['data']['habitat'];?>'>
      <option value="-1">&nbsp;</option> 
      <?php echo $module['habitat_option'];?></select><input type="text" class="hide_input" /> <span class=state></span><a href="#" class=switch_input>&nbsp;</a>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="contain" name="contain" jzdc_value='<?php echo $module['data']['contain'];?>'>
      <option value="-1">&nbsp;</option> 
      <?php echo $module['contain_option'];?></select><input type="text" class="hide_input" /> <span class=state></span><a href="#" class=switch_input>&nbsp;</a>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="position" name="position" jzdc_value='<?php echo $module['data']['position'];?>'>
      <option value="-1">&nbsp;</option> 
      <?php echo $module['position'];?></select><input type="text" class="hide_input" /> <span class=state></span><a href="#" class=switch_input>&nbsp;</a>
		    ...
		    -->
    	<div class=line_div>
        	<span class=m_label><?php echo self::$language['supplier'];?><span class=require>*</span></span>
        	<span class=input_span>
            	<select id="supplier" name="supplier" jzdc_value='<?php echo $module['data']['supplier'];?>'>
      <option value="-1">&nbsp;</option> 
      <?php echo $module['supplier'];?></select><input type="text" class="hide_input" /> <span class=state></span><a href="#" class=switch_input>&nbsp;</a>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="unit" name="unit" jzdc_value='<?php echo $module['data']['unit'];?>'>
      <option value="-1">&nbsp;</option> 
      <?php echo $module['unit'];?></select><input type="text" class="hide_input" /> <span class=state></span><a href="#" class=switch_input>&nbsp;</a>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span><input type="text" name="title" id="title" value='<?php echo $module['data']['title'];?>'  /> <span class=state></span>
				<!--<a  class="search_same" user_color="button" style="padding:5px; line-height:20px;" href=# href_pre="https://search.jd.com/Search?enc=utf-8&keyword=" target="_blank"><?php echo self::$language['search_same']?></a> -->
			</span>
        </div>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span><input type="hidden" id="tag" name="tag"  value='<?php echo $module['data']['tag'];?>'/><?php echo $module['tags'];?>  <span class=state></span><a href="index.php?jzdc=mall.s_tag" class=create><?php echo self::$language['create']?></a>
            </span>
        </div>
        -->
    	<div class=line_div>
     ...
     <!--
		...
		<div class=line_div>
            ...
            <div class=line_div>
                <span class=m_label><?php echo self::$language['sale_price'];?><span class=require>*</span></span>
...
<!--
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="goods_state" name="goods_state" jzdc_value="<?php echo $module['data']['state']?>"><?php echo $module['goods_state']?></select> <span class=state></span>
            </span>
        </div>
...
<!--
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="limit" name="limit" jzdc_value="<?php echo $module['data']['limit']?>"><?php echo $module['buy_limit_option']?></select> <span class=state></span>
            </span>
        </div>

    	<div class=line_div d="buy_limit" style="display:none;">
        	<span class=m_label><?php echo self::$language['buy_limit_cycle'];?></span>
        	<span class=input_span><select id="limit_cycle" name="limit_cycle"  jzdc_value="<?php echo $module['data']['limit_cycle']?>"><?php echo $module['limit_cycle_option']?></select> <span class=state></span></span>
        </div>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="free_shipping" name="free_shipping"  jzdc_value='<?php echo $module['data']['free_shipping'];?>'><option value="0"><?php echo self::$language['no']?></option><option value="1"><?php echo self::$language['yes']?></option></select> <span class=state></span>
            </span>
        </div>
    	...
    	<div class=line_div>
        	...
        	<span class=input_span>
            	<select id="sales_promotion" name="sales_promotion"  jzdc_value='<?php echo $module['data']['sales_promotion'];?>'><option value="1"><?php echo self::$language['yes']?></option><option value="0"><?php echo self::$language['no']?></option></select> <span class=state></span>
            </span>
        </div>
    ...
    <ul class="nav nav-tabs" device_tabs=1>
      <li role="presentation" class="active"><a href="#" target="m_detail_div"><?php echo self::$language['goods'];?><?php echo self::$language['detail'];?></a></li>
	</ul>
    

		<div class="detail_div" style="display:none;"><textarea name="detail" id="detail" style="display:none; width:100%; height:400px;"><?php echo $module['data']['detail'];?></textarea></div>
        <div class="m_detail_div" ><textarea name="m_detail" id="m_detail" style="display:none; width:100%; height:400px;"><?php echo $module['data']['m_detail'];?></textarea></div>
    ...
    .fast_move .fast_move_switch{background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>  !important;  height:30px; line-height:30px;  display:inline-block; border-radius:0px; padding-left:10px; padding-right:10px;}
