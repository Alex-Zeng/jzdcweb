<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .seller .point:before{margin-right:8px; color:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['background']?>; font: normal normal normal 1rem/1 FontAwesome; content:"\f0da";}
