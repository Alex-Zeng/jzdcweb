<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
        ...
        $("#<?php echo $module['module_name'];?> .submit").click(function(){
			...
			$.post('<?php echo $module['action_url'];?>&act=add',obj, function(data){
				...
				if(v.state=='success'){
					...
					$("#<?php echo $module['module_name'];?> .submit").next().html(v.info+' <a href=./index.php?jzdc=mall.create_card_list><?php echo self::$language['view']?></a>');
				}
    ...
    <div id="<?php echo $module['module_name'];?>_html">
    	<div style="text-align:right"><a href=./index.php?jzdc=mall.create_card_list user_color="button" class=create_card_list><?php echo self::$language['pages']['mall.create_card_list']['name']?></a></div>
