<div id=<?php echo $module['module_name'];?>  class="portlet light sum_card" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div id=<?php echo $module['module_name'];?>_html>
    	<a href="./index.php?jzdc=mall.m_order_admin" class=card_head>
    	...
    	<div class=card_body>
        	...
        	<a href='./index.php?jzdc=mall.m_order_admin' class=item>
            ...
            </a><a href='./index.php?jzdc=mall.m_order_admin' class=item>
            ...
            </a><a href='./index.php?jzdc=mall.shop_admin&state=0' class=item>
            ...
            </a><a href='./index.php?jzdc=mall.m_goods_admin' class=item>
            ...
            </a><a href='./index.php?jzdc=mall.m_comment_admin' class=item>
