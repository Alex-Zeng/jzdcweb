<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div id="<?php echo $module['module_name'];?>_html">
		<div class=left>
            ...
            <div class=iframe_div><iframe width="100%" id="print_tag" name="print_tag" height="600px;" id="map" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="./index.php?jzdc=mall.scale_tag_print" >
</iframe></div>
        </div>
    </div>
</div>