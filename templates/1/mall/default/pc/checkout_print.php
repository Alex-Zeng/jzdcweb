<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .order_div .order_body .goods .goods_id{ width:10%;}
	#<?php echo $module['module_name'];?> .order_div .order_body .goods .goods_name{ width:66%;}
	#<?php echo $module['module_name'];?> .order_div .order_body .goods .goods_price{ width:8%;}
	...
	#<?php echo $module['module_name'];?> .o_price{text-decoration: line-through; opacity:0.4; }
	...
	#<?php echo $module['module_name'];?>_html .order .o .g{ width:30%; overflow:hidden;}
	#<?php echo $module['module_name'];?>_html .order .o .b{ width:30%; overflow:hidden;}
	#<?php echo $module['module_name'];?>_html .order .o .q{ width:20%; overflow:hidden;}
	#<?php echo $module['module_name'];?>_html .order .o .p{ width:20%; overflow:hidden;}
	#<?php echo $module['module_name'];?>_html .order .o .s{ width:30%; overflow:hidden; text-align:right;}
    </style>
