<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .p_group b{ display:none; font-weight:normal; background-color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; border-radius:3px; padding-left:3px; padding-right:3px;}
	...
	#<?php echo $module['module_name'];?> .p_group .equal:before{font: normal normal normal 2rem/1 jzdc; content:"\f00c";}
