<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$("#<?php echo $module['module_name'];?>_html .print_set .submit").click(function(){
			...
			window.location.href='./index.php?jzdc=mall.print_bar_code&min='+$("#<?php echo $module['module_name'];?> .print_set .min").val()+'&max='+$("#<?php echo $module['module_name'];?> .print_set .max").val()+"&search="+$("#<?php echo $module['module_name'];?> .print_set #search_filter").val()+"&type="+$("#<?php echo $module['module_name'];?> .print_set #type_filter").val();
			return false;	
		});
