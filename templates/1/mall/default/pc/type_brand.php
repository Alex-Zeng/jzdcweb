<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#brand_source").val($("#brand_source").attr('jzdc_value'));
    ...
    #<?php echo $module['module_name'];?>_html .sequence{width:50px;}
     ...
     <div class=brand_source_div><?php echo self::$language['brand_source'];?><select id=brand_source jzdc_value="<?php echo $module['brand_source'];?>" ><option value="0"><?php echo self::$language['parent_brand'];?></option><option value="1"><?php echo self::$language['self_brand'];?></option></select> <span></span></div>

	<fieldset id="<?php echo $module['module_name'];?>_html"  jzdc-table=1><legend><?php echo self::$language['self_brand'];?></legend>
