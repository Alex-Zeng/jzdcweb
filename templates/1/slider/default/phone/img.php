<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$('.td_last .jzdc_thead_span').css('display','none');
		...
		$('.slider_img').click(function(){
			...
			//jzdc_alert(replace_img);
			$("#fade_div").css('display','block');
			$("#set_jzdc_iframe_div").css('display','block');
			$("#jzdc_iframe").attr('src','index.php?jzdc=index.replace_file&path='+replace_file+'&width=0&height=0&max_size=1024&min_size=1');
			//$(this).html($("#jzdc_iframe").attr('src'));
			return false;	
		});
...
$.get('<?php echo $module['action_url'];?>&act=del',{id:id}, function(data){
	...
	[jzdc-table] .submit{ margin-left:20%;}
