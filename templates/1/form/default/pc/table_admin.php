<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		if(get_param('id')!=''){$("[jzdc-table] .filter").css('display','none');}
	...
	#<?php echo $module['module_name'];?> .sms_inform{ height:13px;}
    ...
    <div class="filter"><?php echo self::$language['content_filter']?>:
        ...
        <a href="#" onclick="return e_search();" class="search"><?php echo self::$language['search']?></a> &nbsp; <a href="./index.php?jzdc=form.table_add"  class="add"><?php echo self::$language['add']?><?php echo self::$language['form']?></a>
    </div>
