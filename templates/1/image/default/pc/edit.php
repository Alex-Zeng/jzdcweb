<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    function exe_check(){
        ...
        if(type.prop('value')<1){jzdc_alert('<?php echo self::$language['please_select']?><?php echo self::$language['belong']?>');type.focus();return false;}
    ...
    <form id="jzdc_form" name="jzdc_form" method="POST" action="<?php echo $module['action_url'];?>&id=<?php echo $_GET['id'];?>" onSubmit="return exe_check();">
      ...
      <?php echo $module['parent'];?></select> <a href="index.php?jzdc=image.type"><?php echo self::$language['create']?></a><br /><br />
