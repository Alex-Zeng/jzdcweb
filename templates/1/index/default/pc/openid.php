...
$(document).ready(function(){
	...
	$("#<?php echo $module['module_name'];?> .submit").click(function(){
		...
		$.post('<?php echo $module['action_url'];?>&act=update',{authcode:$("#<?php echo $module['module_name'];?> .authcode").val()}, function(data){
			...
			if(v.state=='success'){
				$("#<?php echo $module['module_name'];?>").html('<div style="line-height:200px;text-align:center;">'+v.info+' <a href=./index.php?jzdc=index.openid><?php echo self::$language['refresh']?></a></div>');
			}
		});
