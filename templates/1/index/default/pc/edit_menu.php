        ...
        $("#<?php echo $module['module_name'];?>_html .checkbox").click(function(){
            ...
            $("#<?php echo $module['module_name'];?>_html #visible_state").load("<?php echo $module['action_url'];?>",json,function(){
                ...
                if($(this).html().length>5){
                    ...
                    $(this).html(v.info);
                    if(v.state=='fail'){jzdc_alert(v.info);}
                }	
            });
          ...
          <tr>
            ...
            <td id="menu_td">
                <table border="0" cellspacing="1" cellpadding="0" id="index_edit_menu_table"> 
                  <tr>
                    <td rowspan="2" class="step"><a href="index.php?jzdc=index.<?php echo $module['act'];?>_menu&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['menu']?></a></td>
                    <td class=step_view  id="index_view_menu_td"><a href="index.php?jzdc=index.view_menu&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['view']?></a></td>
                  </tr>
                  <tr>
                    <td  class="step_edit" id="index_edit_menu_td"><a href="index.php?jzdc=index.edit_menu&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['edit']?></a></td>
                  </tr>
                </table> 
            ...
            <td id="page_td">
                <table border="0" cellspacing="2" cellpadding="0" id="index_edit_page_table">
                  <tr>
                    <td rowspan="2" class="step"><a href="index.php?jzdc=index.<?php echo $module['act'];?>_page&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['page_power']?></a></td>
                    <td class=step_view  id="index_view_page_td"><a href="index.php?jzdc=index.view_page&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['view']?></a></td>
                  </tr>
                  <tr>
                    <td  class="step_edit" id="index_edit_page_td"><a href="index.php?jzdc=index.edit_page&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['edit']?></a></td>
                  </tr>
                </table>         
            </td>
            <td id="function_td">
                <table border="0" cellspacing="2" cellpadding="0" id="index_edit_function_table" >
                  <tr>
                    <td rowspan="2" class="step"><a href="index.php?jzdc=index.<?php echo $module['act'];?>_function&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['function_power']?></a></td>
                    <td class=step_view  id="index_view_function_td"><a href="index.php?jzdc=index.view_function&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['view']?></a></td>
                  </tr>
                  <tr>
                    <td  class="step_edit" id="index_edit_function_td"><a href="index.php?jzdc=index.edit_function&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['edit']?></a></td>
                  </tr>
                </table>         
            </td>
          </tr>
