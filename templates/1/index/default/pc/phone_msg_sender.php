<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#jzdc_table_filter select").change(function(){
    ...
    <div class=table_scroll><table class="jzdc_table_top_div" width="100%">
    	<tr>
        	<td align="left">    
			<span id=jzdc_table_filter><?php echo self::$language['content_filter']?>:
