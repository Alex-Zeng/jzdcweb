<div id=<?php echo $module['module_name'];?>  jzdc-module="<?php echo $module['module_name'];?>"  align=left >
    ...
    <div id=<?php echo $module['module_name'];?>_html>
        ...
        重置位置条信息
        <div id="user_position_reset" style="display:none;"><a href='index.php'><span id=user_position_icon>&nbsp;</span>网站名称</a><a href='index.php?jzdc=index.user'>用户中心</a><span class=text>position 1</span></div>
        -->
    </div>
</div>