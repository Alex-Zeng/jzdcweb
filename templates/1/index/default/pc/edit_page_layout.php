<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){ 
		...
		if(get_param('program')==''){$("#program_list").css('display','block');$("[jzdc-table] table").css('display','none');}
...
$.get('<?php echo $module['action_url'];?>&act=del',{id:id}, function(data){
	...
	#program_list a img{ width:120px; height:120px; border:none; border-radius:50%; background:<?php echo $_POST['jzdc_user_color_set']['nv_2']['background']?>;}
	#program_list a img:hover{ width:120px; height:120px; border:none; border-radius:50%; background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>;}
	[jzdc-table] .url{ display:inline-block;width:150px; overflow:hidden;}
	[jzdc-table] .module_list{ display:inline-block;width:450px; overflow:hidden;}
	[jzdc-table] .module_list input{ display:inline-block;width:330px; margin-left:5px; overflow:hidden; margin:5px;}
 	[jzdc-table] .layout{ display:inline-block;width:100px; overflow:hidden;}
	[jzdc-table] .target{ display:inline-block;width:100px; overflow:hidden;}
	[jzdc-table] .tutorial{ display:inline-block;width:100px; overflow:hidden;}
