...
<script src="./plugin/datePicker/index.php"></script>
    ...
    $(document).ready(function(){
        ...
        $("#submit_offline").click(function(){
			if(($("#pay_info").val()=="<?php echo $module['pay_info'];?>" || $("#pay_info").val()=='') && $("#pay_photo").val()==''){jzdc_alert("<?php echo self::$language['pay_photo'];?>/<?php echo self::$language['pay_info'];?> <?php echo self::$language['whole_is_null'];?>");return false;}
