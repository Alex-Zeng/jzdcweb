<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div><span class="m_label"><?php echo self::$language['step_1'];?></span><span class=input><?php echo self::$language['download_the_upgrade_patch_from_Lansion_server'];?> <a href="<?php echo $module['download_url'];?>" target="_blank"><?php echo self::$language['click'];?><?php echo self::$language['download'];?></a></span></div>
    <hr />
