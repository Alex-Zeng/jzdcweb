...
.page-header-top .container .page-logo{ display:block; text-align:center; background:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?>; border-bottom:1px dashed #ccc;}
...
.page-header-top .top-menu > ul li li:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?> !important;   }
.page-header-top .top-menu > ul li li:hover a{ color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?> !important; }
...
<div class="page-header-top">
		<div class="container" style="z-index:9999999999;">
			<div class="page-logo">
				<a href="#" class=logo><img src="./white_logo.png"></a>
			</div><div class="top-menu">
				<ul>
					<li class="user_info">
                    	<span class="fadeIn animated infinite  user_msg "><a href="./index.php?jzdc=index.site_msg_addressee"></a></span>
                    	<a href="./index.php?jzdc=index.user" class="user_info_a">
...
$(document).ready(function(){
	$("#<?php echo $module['module_name'];?> .nv ul li").hover(function(){
		if($("html").attr('browser')=='Edge'){
			...
			$(this).children('ul').css('left',$(this).width()-3);
		}
...
#<?php echo $module['module_name'];?>  { text-align:left; background:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?>;}
...
#<?php echo $module['module_name'];?> .nv ul  ul {display: none; position:absolute; left:150px; width:600px; max-height:60%;  white-space:normal; background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:#fff; overflow:scroll; overflow-x:hidden; z-index:999;    box-shadow: 2px 1px 2px 2px rgba(0, 0, 0, 0.1); }
...
#<?php echo $module['module_name'];?> .nv ul li:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
...
.fixed_right_div > a{ width:30px; height:30px; background-color:#525252; border:none; font-weight:normal; margin-bottom:1rem;}
.fixed_right_div a:hover{ font-size:0.8rem;}
.fixed_right_div a i{ width:30px; height:30px; line-height:20px;}
.fixed_right_div a i:before{ color:#fff;font-size:1.5rem; font-weight:normal;}
</style>
...
<div class=nv>
    ...
    <li><a href="./index.php?jzdc=index.edit_email"><span><?php echo self::$language['pages']['index.edit_email']['name']?></span></a></li>
    <li><a href="./index.php?jzdc=index.edit_user&field=password"><span><?php echo self::$language['pages']['index.edit_user&field=password']['name']?></span></a></li>
