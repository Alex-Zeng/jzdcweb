<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$('.icon').click(function(){
			...
			$("#jzdc_iframe").attr('src','index.php?jzdc=index.replace_file&path='+replace_file+'&width=128&height=128');
			return false;	
		});
    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"   id="<?php echo $module['module_name'];?>_table_a" style="width:100%" cellspacing="0">
        ...
        <tbody >
            <tr id="new">
              ...
              <td><input type="text" name="center_new" id="center_new" class='center' jzdc_type="map" /></td>
