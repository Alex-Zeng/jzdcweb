<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div id="<?php echo $module['module_name'];?>_html">
    	<div class=line><span class=m_label><?php echo self::$language['username']?>：</span><span class=input> <input type="text" class=username placeholder="系统登录帐号"> <span class=state></span></span></div>
		...
		<div class=line><span class=m_label><?php echo self::$language['real_name']?>：</span><span class=input> <input type="text" class=realname  placeholder="真实姓名或企业名称"/> <span class=state></span></span></div>
    	...
    	<div class=line style="display:none;"><span class=m_label><?php echo self::$language['introducer']?>(<?php echo self::$language['optional']?>)</span><span class=input> <input type="text" class=introducer /> <span class=state></span></span></div>
    	...
    	<div class=line style="display:none;"><span class=m_label><?php echo self::$language['transaction_password']?></span><span class=input> <input type="text" class=transaction_password  value="<?php echo $module['random']?>" /> <span class=state></span></span></div>
    	<div class=line style="display:none;"><span class=m_label><?php echo self::$language['chip']?>(<?php echo self::$language['optional']?>)</span><span class=input> <input type="text" class=chip  /> <span class=state></span></span></div>
    	<div class=line style="display:none;"><span class=m_label><?php echo self::$language['openid']?><?php echo self::$language['authcode']?>(<?php echo self::$language['optional']?>)</span><span class=input> <input type="text" class=openid  /> <span class=state></span>
