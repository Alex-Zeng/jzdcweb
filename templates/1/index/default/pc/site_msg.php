<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    function exe_check(){
        ...
        if(addressee.prop('value')==''){jzdc_alert('<?php echo self::$language['please_select']?><?php echo self::$language['addressee']?>');addressee.focus();return false;}
        if(title.prop('value')==''){jzdc_alert('<?php echo self::$language['please_input']?><?php echo self::$language['title']?>');title.focus();return false;}
        if(content.prop('value')==''){jzdc_alert('<?php echo self::$language['please_input']?><?php echo self::$language['content']?>');}
    ...
    <form id="jzdc_form" name="jzdc_form" method="POST" action="<?php echo $module['action_url'];?>" onSubmit="return exe_check();">
      <?php echo self::$language['addressee'];?>(<?php echo self::$language['username'];?>)：<a href='./index.php?jzdc=index.admin_users'><?php echo self::$language['select_please'];?></a><br />
