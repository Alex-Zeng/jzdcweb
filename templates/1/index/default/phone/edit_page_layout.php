...
$.get('<?php echo $module['action_url'];?>&act=del',{id:id}, function(data){
	...
	#program_list a img{ width:60%; border:none; border-radius:50%; background:<?php echo $_POST['jzdc_user_color_set']['nv_2']['background']?>;}
	#program_list a img:hover{ background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>;}
