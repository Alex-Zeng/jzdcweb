<div id=<?php echo $module['module_name'];?>  class="portlet light sum_card" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div id=<?php echo $module['module_name'];?>_html>
    	<a href='./index.php?jzdc=index.admin_users' class=card_head>
        	<span class=big_num><?php echo $module['user'];?></span>
            <span class=remark><?php echo self::$language['member'];?></span>
        </a>
    	<div class=card_body>
        	<a href='./index.php?jzdc=index.admin_users' class=item>
            ...
            </div><a href='./index.php?jzdc=index.admin_site_msg' class=item>
            ...
            </a><a href='./index.php?jzdc=index.credits_admin' class=item>
            ...
            </a><a href='./index.php?jzdc=index.recharge_log_admin&state=4' class=item>
            ...
            </a><a href='./index.php?jzdc=index.withdraw_log_admin&state=1' class=item>
