<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	function go_dir(){
		dir=$("#dir_input").val();
		window.location.href='./index.php?jzdc=index.template_edit&dir='+dir;
	...
	function submit_hidden(id){
        ...
        $.post("<?php echo $module['action_url'];?>&act=up_new&dir=<?php echo @$_GET['dir'];?>",{v:str},function(data){
			...
			if(v.state=='success'){jzdc_alert(v.info);window.location.reload();}
        });	
	}
    </script>
	<style>
 ...
 <div class=dir_link><span class=dir>&nbsp;</span><a href='./index.php?jzdc=index.template_edit&dir='>templates</a> / <?php echo $module['dir'];?></div>
