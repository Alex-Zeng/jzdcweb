		...
		<div class="container" style="z-index:9999999999;">
			<div class="page-logo">
				...
				<ul>
					...
					<li class="user_info">
                    	<a href="./index.php?jzdc=index.user">
						...
						<ul class="user_edit_list">
							<li><a href="./index.php?jzdc=index.edit_user"><?php echo self::$language['pages']['index.edit_user']['name']?></a></li>
							<li><a href="./index.php?jzdc=index.edit_phone"><?php echo self::$language['pages']['index.edit_phone']['name']?></a></li>
							<li><a href="./index.php?jzdc=index.edit_email"><?php echo self::$language['pages']['index.edit_email']['name']?></a></li>
							<li><a href="./index.php?jzdc=index.edit_user&field=password"><?php echo self::$language['pages']['index.edit_user&field=password']['name']?></a></li>
							<li><a href="./index.php?jzdc=index.edit_user&field=transaction_password"><?php echo self::$language['pages']['index.edit_user&field=transaction_password']['name']?></a></li>
							<li><a href="./index.php?jzdc=index.site_msg_addressee"><?php echo self::$language['pages']['index.site_msg_addressee']['name']?></a></li>
							<li><a href="./index.php?jzdc=index.login_log"><?php echo self::$language['pages']['index.login_log']['name']?></a></li>
							<li><a href="./index.php?jzdc=index.user_set"><?php echo self::$language['pages']['index.user_set']['name']?></a></li>
							<li><a href="./index.php?jzdc=index.my_oauth"><?php echo self::$language['pages']['index.my_oauth']['name']?></a></li>
							<li><a href="./index.php?jzdc=index.financial_center"><?php echo self::$language['pages']['index.financial_center']['name']?></a></li>
						</ul>
					</li>
                    <li class="fadeIn animated infinite  user_msg "><a href="./index.php?jzdc=index.site_msg_addressee"></a></li>
...
<div class=nv>
	<div class="container"><ul class=nv_ul ><li><a href=index.php?jzdc=index.user><span><?php echo self::$language['user_center']?></span></a></li><li><a href=./index.php?jzdc=index.personal_center><img src="./templates/1/index/default/page_icon/index.personal_center.png" /><span><?php echo self::$language['personal_center']?></span><i class="fa fa-angle-down"></i></a><ul>
