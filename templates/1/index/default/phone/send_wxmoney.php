<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
        ...
        $("#<?php echo $module['module_name'];?> #submit").click(function(){
            ...
            $("#submit_state").load('<?php echo $module['action_url'];?>&act=submit',obj,function(){
                if($(this).html().length>10){
                    ...
                    $(this).html(v.info);
					if(v.state=='success'){
						$(this).html(v.info+' <a href=./index.php?jzdc=index.wxpay><?php echo self::$language['view']?></a>');
					}else{
						if(v.id){
    ...
    <div class="portlet-title">
        ...
        <textarea name="addressee" id="addressee" style=" height:90px; display:block; width:80%;"><?php echo @$_POST['data']?></textarea>  <span class=state></span>  <?php echo self::$language['addressee'];?><?php echo self::$language['separated_by_commas'];?> <a href='./index.php?jzdc=index.admin_users' class="add"><?php echo self::$language['select_please'];?></a>
