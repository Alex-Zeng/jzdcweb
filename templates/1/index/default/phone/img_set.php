<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$('.replace').click(function(){
			...
			$("#jzdc_iframe").attr('src','index.php?jzdc=index.replace_file&path='+replace_file+'&width='+$(this).attr('img_width')+'&height='+$(this).attr('img_height'));
			return false;	
		});
	...
	#jzdc_iframe{ height:100px;width:500px;}
	legend{ }
    </style>
    <div id="<?php echo $module['module_name'];?>_html">
    	...
    	<fieldset><legend><?php echo self::$language['phone_logo'];?>(360*85 png) <a href=# class="replace" file='./phone_logo.png' img_width='360' img_height='85' ><?php echo self::$language['replace'];?></a></legend>
