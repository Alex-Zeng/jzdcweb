<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left  >
		...
		$("#<?php echo $module['module_name'];?> #submit").click(function(){
			...
			$.get(url,function(data){
                ...
                if(v.state=='success'){
                	...
                	window.location.href='./index.php?jzdc='+get_param('url')+'&edit_page_layout=true&id='+get_param('id');
                }
    ...
    <div id="<?php echo $module['module_name'];?>_html">
   	  <div><span class="m_label"><?php echo self::$language['data_src'];?></span><span class=input_span>
      		<select id="id" name="id" jzdc_value="<?php echo $module['id']?>"><?php echo $module['data_src_option'];?></select> <span></span>
      </span></div> 

      
   	  <div><span class="m_label"><?php echo self::$language['template'];?></span><span class=input_span>
      		<select id="template" name="template" jzdc_value="<?php echo $module['template']?>"><?php echo $module['template_option'];?></select><span></span>
      		</span>
      </span></div> 
