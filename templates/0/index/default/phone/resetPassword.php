<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    function exe_check(){
        ...
        top_ajax_form('jzdc_form','act_div','show_result');
        return false;
        }
    ...
    function show_result(){
        ...
        if(json.errType=='none'){window.location.href="index.php?jzdc=index.login&backurl=index.php?jzdc=index.user";}else{
