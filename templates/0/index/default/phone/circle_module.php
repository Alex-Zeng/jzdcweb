<div id=<?php echo $module['module_name'];?> jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		if(circle!=0){
			...
			$(".jzdc_bottom a[jzdc='index.circle'] span").html($("#<?php echo $module['module_name'];?> a[circle='"+circle+"'] span").html());
		}else{
			setCookie('circle',0,30);
			$(".jzdc_bottom a[jzdc='index.circle'] span").html('<?php echo self::$language['circle']?>');
		}
		...
		$(".jzdc_bottom a[jzdc='index.circle']").click(function(){
			$(".jzdc_bottom a").removeClass('current');
			$(".jzdc_bottom  a[jzdc='index.circle']").addClass('current');
			/*
    ...
    #<?php echo $module['module_name'];?>_html .list .circle_div a:hover{ opacity:0.8; border-bottom:3px <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?> solid;} 
    #<?php echo $module['module_name'];?>_html .list .circle_div a img{ width:40%;} 
    #<?php echo $module['module_name'];?>_html .list .circle_div a span{ display:block; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;} 
	...
	.modal-title{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
	
.shequji_home:before{font: normal normal normal 1.6rem/1 jzdc; display:block; content: "\f011";}
.current .shequji_home:before{font: normal normal normal 1.6rem/1 jzdc; display:block; content: "\f010"; }
.shequji_jd:before{font: normal normal normal 1.6rem/1 jzdc; display:block; content: "\f018";}
.current .shequji_jd:before{font: normal normal normal 1.6rem/1 jzdc; display:block; content: "\f018"; }
.shequji_circle:before{font: normal normal normal 1.6rem/1 jzdc; display:block; content: "\f013";}
.current .shequji_circle:before{font: normal normal normal 1.6rem/1 jzdc; display:block; content: "\f012"; }
.shequji_cart:before{font: normal normal normal 1.6rem/1 jzdc; display:block; content: "\f016";}
.current .shequji_cart:before{font: normal normal normal 1.6rem/1 jzdc; display:block; content: "\f016"; }
.shequji_user:before{font: normal normal normal 1.6rem/1 jzdc; display:block; content: "\f015";}
.current .shequji_user:before{font: normal normal normal 1.6rem/1 jzdc; display:block; content: "\f014"; }
