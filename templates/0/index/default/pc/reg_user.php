<div id=<?php echo $module['module_name'];?>  jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		if($(".phone_country").attr('class')){
			...
			$(".phone_country_switch").html('+'+$('.phone_country').attr('jzdc_value'));
...
.title_div a{ display: inline-block; vertical-align:top; width:35%; text-align:right; padding-right:1rem; font-size:0.8rem; overflow:hidden;color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?>;}
...
.agreement_div a{color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?>;}
        ...
        <div class=form_div>
        	<div class=f_body>
                ...
                <form id="jzdc_form" name="jzdc_form" method="GET" action="<?php echo $module['action_url'];?>" onSubmit="return exe_check();">
                  ...
                  <div class=line><span class="m_label"><?php echo self::$language['username'];?>：</span><span class=input_span><input class="input_text" type="text" name="username" id="username" placeholder="4-20位数字、字母、汉字" onfocus="clear_defaut_value();" /></span><span id=username_state></span></div>
