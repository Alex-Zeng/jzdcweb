document.write("<div id=<?php echo $module['module_name'];?> jzdc-module='<?php echo $module['module_name'];?>' align=center >"+
	"<style>"+
    "#<?php echo $module['module_name'];?>{ background-color: #FCFCFC; width:100%; border-bottom: #e6e6e6 solid 1px;}"+
    "#<?php echo $module['module_name'];?> #top_bar{ background-color: #FCFCFC;   margin:auto;  position:relative;  z-index:999; clear:both; text-align:left; line-height:2rem; height:2rem; margin-left:auto; margin-right:auto;}"+
