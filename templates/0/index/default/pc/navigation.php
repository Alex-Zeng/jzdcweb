...
#<?php echo $module['module_name'];?> .nv ul ul {line-height:40px;line-height:2.85rem;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; border-radius: 0px; padding: 0;position: absolute; top: 100%;}
...
#<?php echo $module['module_name'];?> .nv ul ul li:hover {background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>;}
...
#<?php echo $module['module_name'];?> #mall_type_all{    display:inline-block; vertical-align:top; width:17.95rem; text-align:left; font-size:18px; margin-right:20px;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
...
#<?php echo $module['module_name'];?> #mall_type_module_two{ display:none; position:absolute; top:290px; left:6px; z-index:9999;}
    ...
    <div class=nv user_color=shape_head>
        <div class="container"><ul class=nv_ul ><li id=mall_type_all><a class=text href="./index.php?jzdc=mall.show_type"><span>商品服务分类</span></a></li><?php echo $module['data'];?></ul></div>
    </div>
