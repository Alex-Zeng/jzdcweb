<div id=<?php echo $module['module_name'];?> jzdc-module="<?php echo $module['module_name'];?>"  align=left >
    ...
    $(document).ready(function(){
        ...
        if($("#visitor_position_reset").length>0){
			...
			//jzdc_alert( $('#visitor_position').html());
   ...
   #<?php echo $module['module_name'];?>_html #visitor_position{ clear:both; border-bottom:2px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; width:100%; margin:auto; font-weight:bold; padding-bottom:5px; margin-top:10px;  margin-bottom:10px;margin:auto;}
