<div id=<?php echo $module['module_name'];?> jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .form_div{ width:350px; margin:3rem; box-shadow: 0px 2px 5px 2px rgba(0, 0, 0, 0.1); float:right; text-align:left; background:#fff; border-radius:0.6rem; overflow:hidden;}
	#<?php echo $module['module_name'];?>_html .form_div .f_body{ padding:1rem;}
	#<?php echo $module['module_name'];?>_html .form_div .f_body #login_logo_div{ text-align:left; font-weight:bold; height:3rem;}
	...
	#<?php echo $module['module_name'];?>_html .form_div .f_body #input_div .username_div{ border-radius:1rem; margin-bottom:1rem;border: 1px solid #ccc; overflow:hidden;}
	...
	#<?php echo $module['module_name'];?>_html .form_div .f_body #input_div .password_div{ border-radius:1rem; margin-bottom:1rem;border: 1px solid #ccc; overflow:hidden;}
	...
	#<?php echo $module['module_name'];?>_html .form_div .f_body #get_password{ display:inline-block; color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?>; vertical-align:top; width:50%; text-align:left;font-size:1rem; }
	#<?php echo $module['module_name'];?>_html .form_div .f_body #login{display:block; width:70%; margin:auto; text-align:center; margin-top:1rem; margin-bottom:1rem;border-radius:1rem;}
	#<?php echo $module['module_name'];?>_html .form_div .f_body #login:hover{ opacity:0.8;}
	#<?php echo $module['module_name'];?>_html .form_div #register{display:inline-block; vertical-align:top; width:50%; text-align:right;color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?>; font-size:1rem; }
        ...
        <div class=form_div>
        	<div class=f_body>
            	<div id=login_logo_div>
                	<?php echo $module['have_web_account'];?>
                </div>
                <div id=input_div>
