<div id=<?php echo $module['module_name'];?>   jzdc-module="<?php echo $module['module_name'];?>" align=left >
 ...
 #<?php echo $module['module_name'];?>_html .shop_info a{margin-right:10px;}
	...
	#<?php echo $module['module_name'];?>_html .draws_coupon{ display:inline-block; font-weight:normal; height:16px; line-height:16px; overflow:hidden; color:red; }
	#<?php echo $module['module_name'];?>_html .draws_coupon:before{margin-right:2px; font: normal normal normal 1rem/1 FontAwesome; content:'\f0e0'; }
	#<?php echo $module['module_name'];?>_html .draws_coupon:after{margin-right:2px; font: normal normal normal 1rem/1 FontAwesome; content:"\f0da"; }
