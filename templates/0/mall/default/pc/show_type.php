...
$(document).ready(function(){
	...
	$("#<?php echo $module['module_name'];?> .show_sub_div .sub3_a img").each(function(index, element) {
...
#<?php echo $module['module_name'];?>_html .parent_current{  border-right:none; border-left:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?> 3px solid; margin-left:1px; background:#fff;}
...
#<?php echo $module['module_name'];?>_html .sub2_a:hover{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;  }
...
#<?php echo $module['module_name'];?>_html .sub_3 .sub3_a:hover{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
