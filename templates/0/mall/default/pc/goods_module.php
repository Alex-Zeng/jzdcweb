...
$(document).ready(function(){
	...
	if($("#<?php echo $module['module_name'];?> .cover_image").html()!=null){
		...
		$(".w_1200 #<?php echo $module['module_name'];?> .list").css('width',$("#<?php echo $module['module_name'];?>").width()-$("#<?php echo $module['module_name'];?> .cover_image").width()-7);
		$(".w_1680 #<?php echo $module['module_name'];?> .list").css('width',$("#<?php echo $module['module_name'];?>").width()-$("#<?php echo $module['module_name'];?> .cover_image").width()-9);
...
#<?php echo $module['module_name'];?>_html .module_title{font-size:1.3rem; height:5rem;line-height:6rem;  border-bottom:2px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
...
#<?php echo $module['module_name'];?>_html .module_title .sub_type a:hover{color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; border-bottom:3px solid<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
#<?php echo $module['module_name'];?>_html .module_title .sub_type .sub_type_show{ color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;border-bottom:3px solid<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }


#<?php echo $module['module_name'];?>_html .module_title .name{ float:left;min-width:130px; width:<?php echo @$module['img_width'];?>;  }
#<?php echo $module['module_name'];?>_html .module_title .name span{    font-weight:bold;padding-left:5px; padding-right:5px; margin-right:5px;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
#<?php echo $module['module_name'];?>_html .module_title .more{ float:right; font-size:1.1rem; color:#999; display:none; }
#<?php echo $module['module_name'];?>_html .module_title .more:hover{  color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
#<?php echo $module['module_name'];?>_html .g_content{background:#fff; clear:both;}
...
#<?php echo $module['module_name'];?>_html .cover_image img{width:<?php echo @$module['img_width'];?>; height:auto;border:none; padding-top:2px;}
...
#<?php echo $module['module_name'];?>_html .list  .goods{ display:inline-block; vertical-align:top; vertical-align:top; line-height:2rem; width:25%; overflow:hidden; border-left:1px solid #f7f7f7; border-bottom:1px solid #f7f7f7; white-space:nowrap;border:1px solid #f7f7f7;}
#<?php echo $module['module_name'];?>_html .list  .goods:hover{  border:1px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;   }
...
#<?php echo $module['module_name'];?>_html .list  .goods .price_span{ display:inline-block; vertical-align:top; text-align:left; height:28px; line-height:28px; overflow:hidden;  font-size:15px;padding-left:0.5rem; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;  }
...
#<?php echo $module['module_name'];?>_html .list  .line{padding-top:15px; width:100%; padding-bottom:15px; border-bottom:1px solid #e7e7e7; overflow:hidden;  }
...
#<?php echo $module['module_name'];?>_html .list  .line .good_info .price_span{ display:inline-block; vertical-align:top;  overflow:hidden; font-size:24px; font-family:Georgia;  font-weight:bold; height:60px; line-height:60px; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
