...
$(document).ready(function(){
	...
	if(url.indexOf('jzdc=mall.index')>0 || url.indexOf('jzdc=')<0){
...
#<?php echo $module['module_name'];?>_html .parent:nth-last-child(2){ display:none;}
...
#<?php echo $module['module_name'];?>_html .parent:hover{position: relative;z-index:991;border-left:0.15rem solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;background-color:#fcfcfc;  }
...
#<?php echo $module['module_name'];?>_html .parent .level_1_div .level_1 a{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
...
#<?php echo $module['module_name'];?>_html .parent .level_1_div .part_a_div .level_2:hover{ display:inline-block;background-color: #fcfcfc;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
...
#<?php echo $module['module_name'];?>_html .parent  .part_b_div .level_2:hover{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}

[jzdc_layout='full'] #<?php echo $module['module_name'];?>_html .parent .part_a_div{ height:4rem;}
[jzdc_layout='full'] #<?php echo $module['module_name'];?>_html .parent .part_b_div{top:-81px; padding-top:28px; min-height:5.9rem;}
</style>
<script>
	url=window.location.href;
	if(url.indexOf('jzdc=mall.index')>0 || url.indexOf('jzdc=')<0){
...
<div id="<?php echo $module['module_name'];?>_html">
	...
	<a href="./index.php?jzdc=mall.show_type" class=more><span class=icon> </span><span class=name><?php echo  self::$language['more']?><?php echo  self::$language['type']?></span></a>
</div>
</div>