...
$(document).ready(function(){
	...
	if($("#<?php echo $module['module_name'];?>").prev('[jzdc_slider=1]').html()){$("#<?php echo $module['module_name'];?>").height($("#mySwipe").height());}
...
function type_module_left_set_next_div(){
	...
	if(!$("#<?php echo $module['module_name'];?>").next('[jzdc_slider=1]').html()){return false;}
...
#<?php echo $module['module_name'];?>_html .parent_0 a:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
#<?php echo $module['module_name'];?>_html .parent_0 a:hover:after{font: normal normal normal 2rem/1 FontAwesome; content:"\f0d9";color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; padding-left:4px;}
#<?php echo $module['module_name'];?>_html .parent_0 .a_hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
#<?php echo $module['module_name'];?>_html .parent_0 .a_hover:after{font: normal normal normal 2rem/1 FontAwesome; content:"\f0d9";color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>;padding-left:4px;}
...
#<?php echo $module['module_name'];?>_html .parent_0 .icon img{ width:70%;  margin-top:5px; border:0px; background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; border-radius:25%;}
...
#<?php echo $module['module_name'];?>_html .sub_2{ display:none; position:absolute; z-index:999;  min-height:127px;  max-width:800px; box-shadow:1px 0px 3px 0px rgba(0,0,0,.2); padding-right:20px; border-left:none; white-space:nowrap;background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>;}
#<?php echo $module['module_name'];?>_html .sub_2 a{ display:inline-block; line-height:2rem; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>;}
...
#<?php echo $module['module_name'];?>_html .sub_2 .sub2_a:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['text']?>; }
...
#<?php echo $module['module_name'];?>_html .sub_2 .sub_3 a:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['text']?>; }
...
<div id="<?php echo $module['module_name'];?>_html">
    ...
    <a href="./index.php?jzdc=mall.show_type" class=more><span class=icon><img src=./program/mall/type_icon/more.png /></span><span class=name><?php echo  self::$language['more']?><?php echo  self::$language['type']?></span></a>
    </div>
    <?php echo $module['sub'];?>
</div>
</div>