<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .count_info{ text-align:right; padding-right:25px; border:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?> solid 1px;margin-right:20px; margin-left:400px;  overflow:hidden; margin-top:10px;}
	...
	#<?php echo $module['module_name'];?>_html .act_div .go_cart:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['text']?>;}
	...
	#<?php echo $module['module_name'];?> .tr .operation_td { line-height:30px; padding-top:<?php echo $module['operation_td_line_height'];?>px; text-align:left; } 
	 ...
	 #<?php echo $module['module_name'];?>_html .shop_div .shop_info .fulfil_preferential{ display:inline-block; line-height:1.5rem;  padding-left:5px; padding-right:5px;   border-radius:8px;background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>; }
