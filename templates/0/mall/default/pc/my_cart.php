<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		if(old_mall_my_cart==''){
			$("#<?php echo $module['module_name'];?> [jzdc-table] .batch_operation_div_out").css('display','none');
	...
	#<?php echo $module['module_name'];?>_html .batch_operation_div .goods_count{ font-weight:bold; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
	#<?php echo $module['module_name'];?>_html .batch_operation_div .money_count{ font-weight:bold; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
	...
	#<?php echo $module['module_name'];?>_html .sales_promotion{   padding-left:3px;padding-right:3px; margin-left:3px; border-radius:7px;background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>;}
	...
	#<?php echo $module['module_name'];?> .quantity_td .decrease_quantity{ display:inline-block;  width:40px; height:40px; vertical-align:top; margin-top:40px; background:#ddd;}
	#<?php echo $module['module_name'];?> .quantity_td .decrease_quantity:before{font: normal normal normal 1rem/1 FontAwesome; content: "\F068"; padding:0 5px 0 10px;vertical-align: top;
line-height: 40px;margin-left: 5px;}
	#<?php echo $module['module_name'];?> .quantity_td .decrease_quantity:hover{ opacity:0.8; }
	#<?php echo $module['module_name'];?> .quantity_td .quantity{ width:50px; text-align:center; height:40px; line-height:40px; border-radius:0px; border-left:0px; border-right:0px;padding:0px; display:inline-block; vertical-align:top; margin-top:40px;} 
	
	#<?php echo $module['module_name'];?> .quantity_td .add_quantity{ display:inline-block;  width:40px; height:40px; vertical-align:top; margin-top:40px; background:#ddd; }
	#<?php echo $module['module_name'];?> .quantity_td .add_quantity:before{font: normal normal normal 1rem/1 FontAwesome; content: "\F067"; padding:0 5px 0 10px;vertical-align: top;
line-height: 40px;margin-left: 5px;}	
	#<?php echo $module['module_name'];?> .quantity_td .add_quantity:hover{ opacity:0.8; }
	 
	#<?php echo $module['module_name'];?>_html .tr .subtotal_td{  font-weight: bold; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;} 
	...
	#<?php echo $module['module_name'];?> .operation_td .move_to_favorites:hover{ color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}    
	...
	#<?php echo $module['module_name'];?> .operation_td .del:hover{ color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}    
	...
	#<?php echo $module['module_name'];?>_html .operation_td{display:inline-block; vertical-align:top;  width:10%; overflow:hidden; text-align:left;} 
	 ...
	 #<?php echo $module['module_name'];?>_html .shop_div .shop_info .fulfil_preferential{ display:inline-block; vertical-align:top; padding-left:8px; padding-right:8px; line-height:1.5rem;   border-radius:8px;background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>;}
