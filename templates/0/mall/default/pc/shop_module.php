<div id=<?php echo $module['module_name'];?> save_name="<?php echo $module['module_save_name'];?>"  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>"   goods_module="<?php echo $module['module_diy']?>" align=left >
	...
	#<?php echo $module['module_name'];?>_html .list a{ display:inline-block; vertical-align:top; width:15%; margin:0.8%; overflow:hidden; text-align:center;}
	#<?php echo $module['module_name'];?>_html .list a img{ width:90%; border:1px solid #F0F0F0; height:165px; width:165px;}
