<div id=<?php echo $module['module_name'];?>  jzdc-module="<?php echo $module['module_name'];?>" align=left style="display:<?php echo $module['module_show']?>" >
	<script>
...
data=old_cart;
	...
	#<?php echo $module['module_name'];?> #cart_div #cart_goods_div .goods_list_div div .goods_info .title_and_other .title{ height:45px; line-height:45px; overflow:hidden; display:block; font-size:1rem;    white-space: nowrap;text-overflow: ellipsis;}    
	...
	#<?php echo $module['module_name'];?> #cart_div #cart_goods_div .goods_list_div div .goods_info .title_and_other .other .price{ display:inline-block; vertical-align:top; font-size:1rem;  width:50%; overflow:hidden;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }    
	#<?php echo $module['module_name'];?> #cart_div #cart_goods_div .goods_list_div div .del{ height:90px; line-height:90px; width:40px; overflow:hidden; vertical-align:top; display:inline-block; vertical-align:top;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}  
	...
	#<?php echo $module['module_name'];?> #cart_div #cart_goods_div .sum_div .goods_count{ font-weight:bold;   margin-left:3px; margin-right:3px;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}    
	#<?php echo $module['module_name'];?> #cart_div #cart_goods_div .sum_div .money_count_span{ margin-left:20px;}    
	#<?php echo $module['module_name'];?> #cart_div #cart_goods_div .sum_div .money_count_span .money_count{ font-size:24px;  font-weight:bold;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}  
	#<?php echo $module['module_name'];?> #cart_div #cart_goods_div .sum_div .go_w_cashier{ float:right; padding-right:30px; display:inline-block; vertical-align:top;   height:35px; border-radius:5px; line-height:35px;padding:0 20px; margin-top:22px; margin-right:20px;background:<?php echo $_POST['jzdc_user_color_set']['button']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['button']['text']?>;  }  
	#<?php echo $module['module_name'];?> #cart_div #cart_goods_div .sum_div .go_w_cashier:hover{ background:<?php echo $_POST['jzdc_user_color_set']['button_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['button_hover']['text']?>;}  
	...
	#<?php echo $module['module_name'];?> .cart_goods_sum .m{ display:block; min-width:2.2rem; line-height:1.6rem; text-align:center;    border-radius:15px;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
	...
	#<?php echo $module['module_name'];?> .cart_goods_sum .e:before{font: normal normal normal 1rem/1 FontAwesome; content:"\f0d7";color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
	...
	.user_info .top_bar_cart:hover{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
    ...
    <a href=./index.php?jzdc=mall.my_cart class=top_bar_cart><?php echo self::$language['my_cart']?><span class=top_goods_sum>0</span></a>
      	<div id=cart_button_div><a href="./index.php?jzdc=mall.my_cart" class="cart_button_hide_cart_div" ><span class=s> </span><span class=m><?php echo self::$language['my_cart'];?></span><span class=e></span></a></div>
