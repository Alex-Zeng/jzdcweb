<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <div id="<?php echo $module['module_name'];?>_html">
       <div class="portlet-title">
    	...
    	<div class=line><span class=m_label><?php echo self::$language['receiver_name'];?>：</span><span class=value><input type="text" id=name value="<?php echo $module['data']['name'];?>" placeholder="签收人姓名"/> <span class=state></span></span></div>
    	<div class=line><span class=m_label><?php echo self::$language['phone'];?>：</span><span class=value><input type="text" id="phone" value="<?php echo $module['data']['phone'];?>" placeholder="默认绑定手机号码"/> <span class=state></span></span></div>
    ...
    <script src="area_js.php?callback=set_area&input_id=area_id&id=<?php echo $module['data']['area_id'];?>&output=select" id='area_id_area_js'></script>
    	...
    	<div class=line><span class=m_label><?php echo self::$language['address_detail'];?>：</span><span class=value><input type="text" id=detail placeholder="街道、楼宇及门牌号" value="<?php echo $module['data']['detail'];?>" /> <span class=state></span></span></div>
    	...
    	<div class=line><span class=m_label><?php echo self::$language['tag'];?>：</span><span class=value><input type="text" id=tag maxlength="10" placeholder="如：家或公司（选填）" value="<?php echo $module['data']['tag'];?>" /> <span class=state></span></span></div>
