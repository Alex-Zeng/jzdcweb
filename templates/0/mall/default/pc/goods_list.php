<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left style="width:100%;" >
<script>
$(document).ready(function(){
	...
	$("#<?php echo $module['module_name'];?>_html .circle_filter .circle_list a[circle]").click(function(){
		window.location.href='./index.php?jzdc=mall.goods_list&circle='+$(this).attr('circle');return false;
	});
	...
	$("#<?php echo $module['module_name'];?>_html .add_cart").click(function(){
		if($(this).attr('option_enable')==0 || $(this).attr('s_id')!='0'){
			...
			$(this).html('<span class=success><?php echo self::$language['success'];?></span> <a href="./index.php?jzdc=mall.my_cart" class=view><?php echo self::$language['view']?><?php echo self::$language['cart']?></a>');
			return false;
		}
	});
...
#<?php echo $module['module_name'];?>_html .top{ display:inline-block; vertical-align:top;  border:1px solid #e7e7e7; width:100%; margin-bottom:10px; padding-bottom:10px;}
#<?php echo $module['module_name'];?>_html .top .top_label{ display:inline-block; vertical-align:top; vertical-align:top; width:8%; white-space:nowrap; overflow:hidden; text-align:right; padding-right:10px;  line-height:25px; margin-top:5px; font-size:15px; padding-right:1%;}
...
#<?php echo $module['module_name'];?>_html .top .top_html a{ display:inline-block; vertical-align:top; height:2rem; line-height:2rem;  margin-bottom:5px; margin-top:5px; font-size:1.1rem; padding-left:0.5rem; padding-right:0.5rem; width:12%; white-space:nowrap; overflow:hidden;text-overflow: ellipsis;}
#<?php echo $module['module_name'];?>_html .top .top_html a:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
#<?php echo $module['module_name'];?>_html .top .top_html .current{ background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
...
#<?php echo $module['module_name'];?>_html .list .m_label_div{ display:inline-block; vertical-align:top; height:3rem;line-height:3rem;   border-bottom:1px solid #e7e7e7; width:100%; background:#f3f3f3;}
...
#<?php echo $module['module_name'];?>_html .list .m_label_div .left_label .order_div .order:hover{ color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}

#<?php echo $module['module_name'];?>_html .list .m_label_div .left_label .order_div .order_asc{display:inline-block; vertical-align:top; background:#fff;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;  }
#<?php echo $module['module_name'];?>_html .list .m_label_div .left_label .order_div .order_desc{display:inline-block; vertical-align:top; background:#fff; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
...
#<?php echo $module['module_name'];?>_html .list .m_label_div .right_label .show_grid_default:hover{ border:1px solid #e7e7e7; border-top:none;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
#<?php echo $module['module_name'];?>_html .list .m_label_div .right_label .show_grid_current{ border:1px solid #e7e7e7; border-top:none; text-align:center; background:#FFF;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
...
#<?php echo $module['module_name'];?>_html .list .m_label_div .right_label #show_line:hover{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
...
#<?php echo $module['module_name'];?>_html .list .m_label_div .right_label .show_line_default:hover{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
#<?php echo $module['module_name'];?>_html .list .m_label_div .right_label .show_line_current{ border:1px solid #e7e7e7; border-top:none; text-align:center; background:#FFF;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}

#<?php echo $module['module_name'];?>_html .list .goods_list{}



#<?php echo $module['module_name'];?>_html .list .goods_list .goods{ display:inline-block; vertical-align:top; vertical-align:top; width:18.5%; height:25rem; overflow:hidden; margin:0.5rem; margin-bottom:0px; border:0.3rem solid #fff;}
#<?php echo $module['module_name'];?>_html .list .goods_list .goods:hover{ border: 1px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;padding: 3px;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .goods_a .price_span{ display:block; text-align:left; height:2rem; line-height:2rem; overflow:hidden;  font-size:1rem; width:240px; margin:auto; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .goods_a .sum_div .monthly .value{ padding-left:5px;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .goods_a .sum_div .satisfaction .value{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .button_div .add_cart{ display:inline-block; vertical-align:top; display:inline-block; vertical-align:top; height:30px; line-height:30px; border-radius:3px; font-size:1rem;  padding-right:10px;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .button_div .favorite{display:inline-block; vertical-align:top; float:right;  height:30px; line-height:30px; border-radius:2px;  font-size:1rem;  padding-right:10px; background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>; }
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line:hover{ border:1px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;padding: 18px 3px 18px 3px; margin-bottom:-3px;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .bottom .sum_div .monthly .value{ padding-left:5px;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .bottom .sum_div .satisfaction .value{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
