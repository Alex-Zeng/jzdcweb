...
<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_html .order_info{ padding-left:30px; height:150px; margin-bottom:40px; } 
	...
	#<?php echo $module['module_name'];?>_html .order_info .act_state:before{font: normal normal normal 6rem/1 FontAwesome;line-height:10.71rem; content:"\f046";color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
    ...
    #<?php echo $module['module_name'];?>_html .pay_method_option .option a{ display: inline-block; vertical-align:top; text-align:center; margin-left:20px; margin-right:20px; width:15%;    font-size:20px;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;} 
    ...
    #<?php echo $module['module_name'];?>_html .pay_method_option .option .selected div:after {font: normal normal normal 1rem/1 FontAwesome;content: "\f0d7";font-size:3rem;  line-height:0.6rem;display:block; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
	...
	#<?php echo $module['module_name'];?>_html .payment img{width:18%;padding:2rem;}
