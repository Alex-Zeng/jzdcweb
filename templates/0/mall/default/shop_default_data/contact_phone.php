...
<iframe width="100%" height="500" id="map" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://{map_api}.lansion.cn/map.php?point={position}&zoom=16&&icon={logo_path}&icon_width=200&icon_height=75&map_width=100%&map_height=500px&company={shop_name}" template="http://{map_api}.lansion.cn/map.php?point={shop_position}&zoom=16&&icon={logo_path}&icon_width=200&icon_height=75&map_width=100%&map_height=500px&company={shopName}">
</iframe>
