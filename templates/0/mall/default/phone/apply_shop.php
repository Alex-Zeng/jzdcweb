<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    <span id="home_area_state" ></span>
    	...
    	<div class=line><span class=m_label><?php echo self::$language['in_position'];?></span><span class=input_span><input type="text" id="position" name="position" jzdc_type="map" /> <span class=state></span></span></div>
