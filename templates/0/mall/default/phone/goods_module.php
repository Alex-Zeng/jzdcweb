...
#<?php echo $module['module_name'];?>_html .module_title{font-size:1.3rem; height:3rem;line-height:3rem;  border-bottom:2px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; padding-left:10px; padding-right:5px; }
...
#<?php echo $module['module_name'];?>_html .list  .goods{ display:inline-block; vertical-align:top; vertical-align:top; width:49%; overflow:hidden; border-left:1px solid #f7f7f7; border-bottom:1px solid #f7f7f7; white-space:nowrap;border:1px solid #f7f7f7; padding-bottom:1rem;}
...
#<?php echo $module['module_name'];?>_html .list  .goods .goods_a{ display:block; text-align:center; padding-bottom:1rem;}
#<?php echo $module['module_name'];?>_html .list  .goods .goods_a img{ height:13rem; margin-top:0.5rem; border:none;}
...
#<?php echo $module['module_name'];?>_html .list  .goods .price_span{ display:inline-block; vertical-align:top;  overflow:hidden; margin-left:10px; text-align:left; height:2rem;line-height:2rem;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
...
#<?php echo $module['module_name'];?>_html .list .goods .button_div{  display:inline-block; vertical-align:top; width:50%; text-align:right;white-space:nowrap; line-height:2rem;}
...
#<?php echo $module['module_name'];?>_html .list  .line{width:100%; padding:1rem;border-bottom:1px solid #e7e7e7; overflow:hidden;  }
...
#<?php echo $module['module_name'];?>_html .list  .line .price_span{display:inline-block; vertical-align:top; width:50%;  line-height:2rem;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
