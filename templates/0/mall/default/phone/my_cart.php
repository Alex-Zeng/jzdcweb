<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$(".jzdc_head").append('<a href=# class=show_edit_div><?php echo self::$language['edit']?></a>');
		$(".edit_div a").html('');
		...
		if(old_mall_my_cart==''){$("#<?php echo $module['module_name'];?> [jzdc-table] .batch_operation_div_out").css('display','none');}
		...
		function set_batch_position(){
			...
			//$("#<?php echo $module['module_name'];?> .batch_operation_div").css('bottom',$(".jzdc_bottom").height());
		}
		set_batch_position();
    ...
    <style>
	.jzdc_bottom,.cart_goods_sum,.fixed_right_div,#index_foot,#index_device,.jzdc_bottom_switch{ display:none !important;}
	.page-container{ padding-bottom:0px;}
	.page-footer{background: #F6F6F6;}
	#<?php echo $module['module_name'];?>{background: #F6F6F6; margin:0px;} 
	#<?php echo $module['module_name'];?>_html {} 
	#<?php echo $module['module_name'];?>_html .checkbox_td{ display:inline-block; vertical-align:top; width:10%; overflow:hidden;}
	
	 
	#<?php echo $module['module_name'];?>_html .shop_div{  margin:0.5rem; margin-top:1rem;box-shadow: 0px 2px 5px 2px rgba(0, 0, 0, 0.1);background-color: #fff;} 
	...
	#<?php echo $module['module_name'];?>_html .shop_div .shop_info .text{ display:inline-block; vertical-align:top; width:90%; overflow:hidden;} 
	#<?php echo $module['module_name'];?>_html .shop_div .shop_info .text .name{ font-weight:bold; display:block; white-space:nowrap; overflow:hidden;text-overflow: ellipsis} 
	...
	#<?php echo $module['module_name'];?>_html .shop_div .shop_info .text .fulfil_preferential{  line-height:1.2rem; display:block; white-space:nowrap; overflow:hidden;text-overflow: ellipsis; color: #CCC;} 
	
	#<?php echo $module['module_name'];?>_html .shop_div .shop_goods{} 
	#<?php echo $module['module_name'];?>_html .shop_div .shop_goods .goods{ height:5rem; border-bottom: 1px dashed #CCCCCC; margin-top:10px;} 
	#<?php echo $module['module_name'];?>_html .shop_div .shop_goods .goods:last-child{ border:none;}
	#<?php echo $module['module_name'];?>_html .shop_div .shop_goods .goods .goods_td{ display:inline-block; vertical-align:top; width:70%; overflow:hidden;} 
	...
	#<?php echo $module['module_name'];?> .quantity_td .decrease_quantity{ display:inline-block;  width:2.5rem;text-align:center; vertical-align:top; background:#f5f5f5;}
	#<?php echo $module['module_name'];?> .quantity_td .decrease_quantity:before{font: normal normal normal 1rem/1 FontAwesome; content: "\F068";}
	...
	#<?php echo $module['module_name'];?> .quantity_td .add_quantity{ display:inline-block;  width:2.5rem;text-align:center;vertical-align:top; background:#f5f5f5; }
	#<?php echo $module['module_name'];?> .quantity_td .add_quantity:before{font: normal normal normal 1rem/1 FontAwesome; content: "\F067";}	
	#<?php echo $module['module_name'];?> .quantity_td .unit{ display:none;}
	#<?php echo $module['module_name'];?> .quantity_td .unit_gram{ display:none;}
	
	
	#<?php echo $module['module_name'];?>_html .shop_div .shop_goods .goods .act_td{display:inline-block; text-align:right; vertical-align:top; width:20%; overflow:hidden;} 
	#<?php echo $module['module_name'];?>_html .shop_div .shop_goods .goods .act_td div{ margin-right:5px;}
	...
	#<?php echo $module['module_name'];?>_html .shop_div .shop_goods .goods .act_td .subtotal{ color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
	#<?php echo $module['module_name'];?>_html .shop_div .shop_goods .goods .act_td .edit_div{ display:none; line-height:2.5rem;} 

	#<?php echo $module['module_name'];?>_html .batch_operation_div{ position:fixed; width:100%; bottom:0px; line-height:3.5rem; height:3.5rem;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; } 
	...
	#<?php echo $module['module_name'];?>_html .batch_operation_div #act_button{ display:inline-block; margin-right:1rem; line-height:2rem;   border-radius:5px; padding:5px;background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>; }
    ...
    <div id="<?php echo $module['module_name'];?>_html">
        ...
        <div class=batch_operation_div>
        	<div class=checkbox_td><span class='m_checkbox all_checkbox ' ></span><div><?php echo self::$language['select_all']?></div></div><div class=sum_td><?php echo $module['sum_info'];?></div><div class=act_td><a href="./index.php?jzdc=mall.confirm_order&goods_src=selected_goods" id=act_button><span class=text><?php echo self::$language['settlement']?></span>(<span class=goods_count></span>)</a></div>
        </div>
