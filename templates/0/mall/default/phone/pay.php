...
<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_html .order_info .act_state{ text-align:center; display:inline-block; vertical-align:top;   width:22%; padding-left:1%;} 
	#<?php echo $module['module_name'];?>_html .order_info .act_state:before{font: normal normal normal 6rem/1 FontAwesome;content:"\f046";color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
    ...
    #<?php echo $module['module_name'];?>_html .order_info .info .time_limit .time{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; } 
    ...
    #<?php echo $module['module_name'];?>_html .pay_method_option .option a{ display: inline-block; vertical-align:top; text-align:center; width:30%; margin-right:3.33%; background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; } 
    ...
    #<?php echo $module['module_name'];?>_html .pay_method_option .option .selected div:after {font: normal normal normal 1rem/1 FontAwesome;content: "\f0d7";font-size:2rem;  line-height:0.5rem;display:block;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
	...
	#<?php echo $module['module_name'];?>_html  #balance_div .recharge_div{ text-align:center;  font-weight:normal;}
	#<?php echo $module['module_name'];?>_html .payment img{width:30.33%; margin:1.5%;}
