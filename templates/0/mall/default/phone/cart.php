<div id=<?php echo $module['module_name'];?>  jzdc-module="<?php echo $module['module_name'];?>" align=left style="display:<?php echo $module['module_show']?>" >
    ...
    $(document).ready(function(){
		$("#<?php echo $module['module_name'];?>_html .cart_goods_sum").css('bottom',$('.jzdc_bottom').height()-5).css('left','47%');
...
temp=old_cart;
	...
	#<?php echo $module['module_name'];?> .cart_goods_sum .m{ display:block; min-width:1.5rem; line-height:1rem; text-align:center;    border-radius:15px;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
