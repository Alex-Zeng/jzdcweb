...
$(document).ready(function(){
	...
	jzdc=get_param('jzdc');
	if(jzdc=='shop.goods_list' && get_param('type')!=''){
...
#<?php echo $module['module_name'];?>_html .type .parent{font-size:1.71rem; height:4.28rem;line-height:4.28rem;  background-position:top;    padding-left:25px;   font-weight:bold;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
...
#<?php echo $module['module_name'];?>_html .type .current_type{ font-weight:bolder; background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>;  }
...
#<?php echo $module['module_name'];?>_html .type .type_deep_1 a:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['text']?>;  }
