<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		if(get_param('geo')==''){
			...
			function showPosition(position){
				...
				window.location.href='./index.php?jzdc=mall.shop_list&geo='+v;
			  
			}
		}else{
			user_geo=get_param('geo');
		...
		$("#<?php echo $module['module_name'];?>_html .near_div a").click(function(){
			if($(this).attr('near')=='100'){window.location.href='./index.php?jzdc=mall.shop_map';return false;}
			url=window.location.href;
	...
	#<?php echo $module['module_name'];?>_html .filter{margin-bottom: 1rem;box-shadow: 0px 2px 5px 2px rgba(0, 0, 0, 0.1);padding: 0.5rem; display:block; width:100%;}
	...
	#<?php echo $module['module_name'];?>_html .shop_div{ margin-top: 1rem;margin-bottom: 1rem;box-shadow: 0px 2px 5px 2px rgba(0, 0, 0, 0.1);padding: 0.5rem; display:block; width:100%; background:#fff;}	
	#<?php echo $module['module_name'];?>_html .shop_div .info{ display:block; white-space:nowrap; font-size:12px;}	
	...
	#<?php echo $module['module_name'];?>_html .shop_div .info .icon img{ width:80%;border:none; border-radius:1rem;}
	...
	#<?php echo $module['module_name'];?>_html .shop_div .info .other .area{}
	#<?php echo $module['module_name'];?>_html .shop_div .info .other .area .address{display:inline-block; vertical-align: top; width:55%; overflow:hidden;    text-overflow: ellipsis;}
	#<?php echo $module['module_name'];?>_html .shop_div .info .other .area .distance:before{font: normal normal normal 14px/1 FontAwesome;margin-right: 5px; content: '\f041';}
	#<?php echo $module['module_name'];?>_html .shop_div .info .other .area .distance{display:inline-block; vertical-align: top; width:30%; overflow:hidden; text-align:right;}
	...
	#<?php echo $module['module_name'];?>_html .shop_div .goods a{ display:inline-block; vertical-align:top; width:23%; text-align:center;  border:solid  #F5F5F5 1px; margin-right:2%;}	
	...
	#<?php echo $module['module_name'];?>_html .phone_filter{  white-space:nowrap; margin-bottom:0.5rem; line-height:2rem;}
	#<?php echo $module['module_name'];?>_html .phone_filter div{ display:inline-block; vertical-align:top; width:33%; overflow:hidden; }
	#<?php echo $module['module_name'];?>_html .phone_filter .c{ border-bottom:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?> 2px solid;}	
	...
	#<?php echo $module['module_name'];?>_html .near_div a:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; opacity:0.7;}
	#<?php echo $module['module_name'];?>_html .near_div .c{background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;  }
    ...
    <div class="filter">
        ...
        <div class=circle_filter filter=circle>
