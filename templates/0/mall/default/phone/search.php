<div id=<?php echo $module['module_name'];?>  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		if(get_param('jzdc')=='' || get_param('jzdc')=='index.index'){
			...
			$(".jzdc_head,.cart_goods_sum,.jzdc_bottom_switch").css('display','none');
			$(".jzdc_head").css('margin-top','-1000px');
		}
		
		$("#<?php echo $module['module_name'];?> .for_index_search .search_input_span input").focus(function(){
			window.location.href='./index.php?jzdc=mall.search';
			return false;
		});
		...
		$("[jzdc='mall.search']").click(function(){
			window.location.href='./index.php?jzdc=mall.search';
			return false;
		});
    ...
    <style>
	#index_phone_bottom .jzdc_head a{ display:none !important;}
	...
	#<?php echo $module['module_name'];?> .for_index_search{ display:none;  padding-top:0.5rem; padding-bottom:2px;  z-index:99999999; background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; width:100%; line-height:1.6rem;}
    ...
    <div class=for_index_search>
    	<span class=logo_span><img src=./phone_logo.png /></span><span class=search_input_span><input type="text" placeholder="<?php echo $module['jzdc_search_placeholder']?>" /></span><span class=type_span ><a href=./index.php?jzdc=mall.show_type></a></span>
    </div>
