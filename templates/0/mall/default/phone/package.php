...
temp=$("#"+id+" .json").html();
    ...
    #<?php echo $module['module_name'];?>_html .g{ margin-bottom:20px;}
    ...
    #<?php echo $module['module_name'];?>_html .g .icon{ display:inline-block; vertical-align:top; width:200px; vertical-align:top;}
    #<?php echo $module['module_name'];?>_html .g .icon img{ width:200px; height:200px; border:none;}
    #<?php echo $module['module_name'];?>_html .g .other{ padding-left:10px; display:inline-block; vertical-align:top; width:1050px;vertical-align:top;}
    ...
    #<?php echo $module['module_name'];?>_html .g .other .price_inventory .normal .money_symbol{}
    #<?php echo $module['module_name'];?>_html .g .other .price_inventory .normal .value{ text-decoration:line-through; padding-right:50px;}
    #<?php echo $module['module_name'];?>_html .g .other .price_inventory .discount .m_label{}
    #<?php echo $module['module_name'];?>_html .g .other .price_inventory .discount .money_symbol{}
    #<?php echo $module['module_name'];?>_html .g .other .price_inventory .discount .value{  padding-right:20px;font-size: 24px;font-weight: bold;font-family: Georgia, "Times New Roman", Times, serif;}
	...
	#<?php echo $module['module_name'];?>_html .g .spec .color_label{ display:inline-block; vertical-align:top; line-height:35px; vertical-align:top; text-align:right; padding-right:10px; width:50px; overflow:hidden;}
	#<?php echo $module['module_name'];?>_html .g .spec .color_line_div{ margin-top:20px; margin-bottom:20px;}
	#<?php echo $module['module_name'];?>_html .g .spec .color_option{ display:inline-block; vertical-align:top; vertical-align:top; overflow:hidden; width:980px;}
	#<?php echo $module['module_name'];?>_html .g .spec .color_option a{ margin-left:4px; margin-right:4px; display:inline-block; vertical-align:top; line-height:30px; height:30px; vertical-align:top; border:1px solid #ccc; overflow:hidden; padding:5px;  margin-bottom:10px;}
	...
	#<?php echo $module['module_name'];?>_html .g .spec .option_label{ display:inline-block; vertical-align:top; line-height:32px; vertical-align:top; text-align:right; padding-right:10px; width:50px; overflow:hidden;}
	#<?php echo $module['module_name'];?>_html .g .spec .option_line_div{ margin-top:20px; margin-bottom:20px;}
	#<?php echo $module['module_name'];?>_html .g .spec .option_option{ display:inline-block; vertical-align:top; vertical-align:top;overflow:hidden;  width:980px; }
