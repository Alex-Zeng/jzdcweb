...
.show_sub_div .title{ text-align:left;line-height:2rem; height:2rem; border-bottom:2px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; margin-bottom:5px; padding-right:10%; font-weight:bold;}
