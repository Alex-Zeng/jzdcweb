...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .goods_a .price_span{ display:block;text-align:left; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .button_div .add_cart:before {font: normal normal normal 1rem/1 FontAwesome; content: "\F067"; padding:0 5px 0 10px;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .top2 .price_span{ display:block; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
...
#<?php echo $module['module_name'];?>_html .goods_filters .sort_div{ display:none; vertical-align:top; width:65%; overflow:hidden; text-indent:1rem;}
...
#<?php echo $module['module_name'];?>_html .goods_filters .option_div{ display:none; vertical-align:top; width:15%; overflow:hidden;text-align:right;}
...
#<?php echo $module['module_name'];?>_html .goods_filters .show_method a:hover{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
...
#<?php echo $module['module_name'];?>_html .goods_filters .show_method .show_grid_current{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
...
#<?php echo $module['module_name'];?>_html .goods_filters .show_method .show_line_current{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
...
#<?php echo $module['module_name'];?>_html .sort_options .used{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
