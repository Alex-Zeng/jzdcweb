...
#<?php echo $module['module_name'];?> .nv{ text-align:left; margin:0px; padding:0px; height:50px; height:3.572rem; line-height:50px;line-height:3.572rem; background-color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['background']?>;  font-size:1rem;  color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['text']?>; white-space:nowrap;}
#<?php echo $module['module_name'];?> .nv a{color:<?php echo $_POST['jzdc_user_color_set']['nv_1']['text']?>; white-space:nowrap;}
...
#<?php echo $module['module_name'];?> .nv ul li:hover {background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
...
#<?php echo $module['module_name'];?> .nv ul ul {line-height:40px;line-height:2.85rem;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;  border-radius: 0px; padding: 0;position: absolute; top: 100%;}
...
#<?php echo $module['module_name'];?> .nv ul ul li:hover {background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>; }
#<?php echo $module['module_name'];?> .nv ul ul ul {width:100%;position: absolute; left: 100%; top:0;background:<?php echo $_POST['jzdc_user_color_set']['nv_3']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_3']['text']?>; }
#<?php echo $module['module_name'];?> .nv ul ul ul li:hover{background:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_3_hover']['text']?>;}
