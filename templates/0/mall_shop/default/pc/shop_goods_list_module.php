...
#<?php echo $module['module_name'];?>_html .module_title{font-size:1.4rem; height:4rem;line-height:4rem;  border-bottom:3px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; padding-right:25px; overflow:hidden;box-shadow:0px 1px 5px #ccc; text-indent:10px; box-shadow:none;}
...
#<?php echo $module['module_name'];?>_html .module_title .sub_type a:hover{ background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;  }
#<?php echo $module['module_name'];?>_html .module_title .sub_type .sub_type_show{background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;    }
...
#<?php echo $module['module_name'];?>_html .module_title .name span{   background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;    font-weight:bold; padding-left:5px; padding-right:5px; margin-right:5px;}
...
#<?php echo $module['module_name'];?>_html .list  .goods .price_span{ display:inline-block; vertical-align:top; text-align:left; height:28px; line-height:28px; overflow:hidden;  font-size:1rem;padding-left:10px;  width:60%; overflow:hidden; text-overflow: ellipsis;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
