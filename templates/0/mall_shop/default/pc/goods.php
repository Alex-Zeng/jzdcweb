...
<div id=<?php echo $module['module_name'];?>  save_name="<?php echo $module['module_save_name'];?>"  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    $(document).ready(function(){
		...
		$("#<?php echo $module['module_name'];?> .pre_sale_rules").hover(function(){
			if($(".col-md-10").html()){
				$(".pre_sale_rules_description").css('top','220px');
			}else{
...
//		}
		...
		$("#<?php echo $module['module_name'];?>_html .add_cart").click(function(){
			...
			$("#<?php echo $module['module_name'];?>_html .cart_state").html('<span class=success><?php echo self::$language['success'];?></span> <a href="./index.php?jzdc=mall.my_cart" class=view user_color=button><?php echo self::$language['view']?><?php echo self::$language['my_cart']?></a>');
	...
	function remove_cart_state_animate(){
		...
		$("#<?php echo $module['module_name'];?>_html .cart_state").html('<a href="./index.php?jzdc=mall.my_cart" class=view user_color=button><?php echo self::$language['view']?><?php echo self::$language['my_cart']?></a>');
	}
...
#<?php echo $module['module_name'];?> a{}
	...
	#<?php echo $module['module_name'];?>_html #goods_act_div #thumb_img_div #thumb_list_div .show_left_able{ color:<?php echo $_POST['jzdc_user_color_set']['button']['background']?>;}}
	#<?php echo $module['module_name'];?>_html #goods_act_div #thumb_img_div #thumb_list_div .show_left_able:hover{ color:<?php echo $_POST['jzdc_user_color_set']['button_hover']['background']?>;}
	...
	margin-left:5px;
	content: "\f0da";}
	#<?php echo $module['module_name'];?>_html #goods_act_div #thumb_img_div #thumb_list_div .show_right_able{color:<?php echo $_POST['jzdc_user_color_set']['button']['background']?>;}
     #<?php echo $module['module_name'];?>_html #goods_act_div #thumb_img_div #thumb_list_div .show_right_able:hover{ color:<?php echo $_POST['jzdc_user_color_set']['button_hover']['background']?>; }
   ...
   #<?php echo $module['module_name'];?>_html #goods_act_div #thumb_img_div #thumb_list_div .show_right_disable:before{
    ...
    #<?php echo $module['module_name'];?>_html #goods_act_div #thumb_img_div #thumb_list_div .current{ border:3px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; padding:5px; width:89px; height:95px; opacity:1.0;}
    ...
    #<?php echo $module['module_name'];?>_html #goods_act_div #act_div .price_info{ height:100px; margin-right:-1px; overflow:hidden;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
	...
	#<?php echo $module['module_name'];?>_html #goods_act_div #act_div .specifications .color_option a:hover{ border:1px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
	#<?php echo $module['module_name'];?>_html #goods_act_div #act_div .specifications .color_option a:hover img{}
	#<?php echo $module['module_name'];?>_html #goods_act_div #act_div .specifications .color_option .selected{border:2px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
	...
	#<?php echo $module['module_name'];?>_html #goods_act_div #act_div .specifications .option_option a:hover{ border:1px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
	#<?php echo $module['module_name'];?>_html #goods_act_div #act_div .specifications .option_option .selected{ border:2px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
...
div.zoomMask{position:absolute;background:url("<?php echo get_template_dir(__FILE__);?>img/mask.png") repeat scroll 0 0 transparent;cursor:move;z-index:1;}
	...
	#<?php echo $module['module_name'];?>_html #relevance_package_div .result_div .package_price .value{ font-weight:bold;color: <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
	...
	#<?php echo $module['module_name'];?>_html #relevance_package_div .result_div .save_money .value{ font-weight:bold;color: <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
	...
	#<?php echo $module['module_name'];?>_html #comment_div .comment_label a:hover{   border:none;background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>;  }
	#<?php echo $module['module_name'];?>_html #comment_div .comment_label .selected{  border:none;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
    ...
    #<?php echo $module['module_name'];?> .buyer .content .seller .time{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
	...
	#<?php echo $module['module_name'];?>_html #sold_div #sold_table thead{ box-shadow:0px 2px 0px 0px rgba(221,226,231,.9); line-height:2rem;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
	...
	#<?php echo $module['module_name'];?>_html #sold_div #sold_table tbody tr:hover td{ border-bottom:solid 1px <?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>;  }
	#<?php echo $module['module_name'];?>_html #sold_div .sold_page{ display:block; text-align:center;}
	
	#<?php echo $module['module_name'];?>_html .position{  border-bottom:2px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;font-weight:bold;padding-left:15px;  margin-bottom:10px; margin-top:5px;  margin:auto;}
