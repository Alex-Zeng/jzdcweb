...
#<?php echo $module['module_name'];?> { margin-top:5px; white-space:normal;}
...
#<?php echo $module['module_name'];?>_html .list .m_label_div .right_label .show_line_current{background:#fff;  color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }

#<?php echo $module['module_name'];?>_html .list .goods_list{ padding-top:10px; padding-left:10px;}



#<?php echo $module['module_name'];?>_html .list .goods_list .goods{ display:inline-block; vertical-align:top; vertical-align:top;  width:20%; height:24rem;  overflow:hidden; border:4px solid #fff; margin-bottom:1rem;	}
...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .button_div .favorite{display:inline-block; vertical-align:top; float:right; display:inline-block; vertical-align:top; height:2rem; line-height:2rem; border-radius:2px;font-size:1rem;  padding-right:10px;background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>; }
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .bottom .button_div .favorite{display:inline-block; vertical-align:top; float:right;  height:30px; line-height:30px; border-radius:2px;  font-size:1rem;  padding-right:10px; margin-left:2rem;background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>; }
