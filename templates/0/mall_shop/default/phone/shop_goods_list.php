...
#<?php echo $module['module_name'];?>_html .list .goods_list .goods .goods_a .price_span{ display:block; text-align:left; font-size:1rem;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?> !important; }
...
#<?php echo $module['module_name'];?>_html .list .goods_list .line .good_info .button_div{display:inline-block !important; vertical-align:top; width:40%; overflow:hidden;}
