...
#<?php echo $module['module_name'];?>_html .module_title{font-size:1.1rem; height:3rem;line-height:3rem;  border-bottom:3px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; padding-right:25px; overflow:hidden;box-shadow:0px 1px 5px #ccc; text-indent:10px; box-shadow:none;}
...
#<?php echo $module['module_name'];?>_html .list  .line .good_info .price_span{ display:inline-block; vertical-align:top;  overflow:hidden; font-size:1.2rem; font-family:Georgia;  font-weight:bold; height:60px; line-height:60px;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;  width:60%; overflow: hidden; white-space:nowrap;text-overflow: ellipsis;}
