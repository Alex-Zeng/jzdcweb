<div id=<?php echo $module['module_name'];?>  save_name="<?php echo $module['module_save_name'];?>"  class="portlet light" jzdc-module="<?php echo $module['module_name'];?>" align=left  >
	<script>
    ...
    $(document).ready(function(){
		...
		$(".jzdc_head .page_name").html('<?php echo self::$language['pages']['mall.goods']['name']?>');
		...
		if(<?php echo $module['data']['state']?>==1){
			...
			$("#<?php echo $module['module_name'];?> .buy_now").html('<?php echo self::$language['goods_state_act'][1]?>').css('width','76.66%');
		}
		if(<?php echo $module['data']['state']?>==3){
			$("#<?php echo $module['module_name'];?> .add_cart").css('display','none');	
			$("#<?php echo $module['module_name'];?> .enter_store").html('<?php echo self::$language['goods_state_act'][3]?>').css('width','76.66%');
		}

        if(<?php echo $_SESSION['jzdc']['group_id']?> !=4){ //非采购商
            $("#<?php echo $module['module_name'];?> .buy_now").css('display','none');
            $("#<?php echo $module['module_name'];?> .favorite").css('width','98%');
        }
		...
		$("#<?php echo $module['module_name'];?>_html .add_cart").click(function(){
			if($(this).html()=='<?php echo self::$language['add_cart']?>'){
				...
				$("#<?php echo $module['module_name'];?>_html .add_cart").html('<div class=cart_state><span class=success><?php echo self::$language['success'];?></span><a href="./index.php?jzdc=mall.my_cart"><?php echo self::$language['view']?></a></div>');
	...
	function remove_cart_state_animate(){
		...
		$("#<?php echo $module['module_name'];?>_html .cart_state").html('<a href="./index.php?jzdc=mall.my_cart" ><?php echo self::$language['view']?><?php echo self::$language['my_cart']?></a>');
	}
	...
	function show_goods_option_div(v){
		if(v==0){
			$("#<?php echo $module['module_name'];?> .jzdc_head").css('display','none');
    ...
    <style>
	.jzdc_bottom,.jzdc_bottom_switch,#mall_cart,#mall_menu{ display:none !important;}
    #<?php echo $module['module_name'];?>{ overflow:hidden;  background:<?php echo $_POST['jzdc_user_color_set']['container']['background']?>;  }
    ...
    #<?php echo $module['module_name'];?>_html #goods_act_div #act_div .price_info{  font-weight:bold; padding-top:0.5rem; padding-bottom:0.5rem;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
	...
	#<?php echo $module['module_name'];?>_html .log_div .value{ font-weight:bold;color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
    #<?php echo $module['module_name'];?>_html #goods_act_div #act_div .fulfil_preferential{ display:none;    padding:0.5rem;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
	...
	font: normal normal normal 35px/1 jzdc;
	content: "\f00C";}
	...
	#goods_company_div{padding-top:15px;padding-bottom: 15px;  border:1px solid #e7e7e7; border-top:0px; background:#fff;border-top: 3px solid #0b7cd2}
	...
	#<?php echo $module['module_name'];?>_html #goods_detail_div #m_label_div .current{   border-top:3px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; background:#fff;}
	...
	#<?php echo $module['module_name'];?>_html #comment_div .comment_title{ height:3rem; line-height:3rem;   padding-left:2%; width:100%; font-size:1.2rem;background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?>; }
	...
	#<?php echo $module['module_name'];?>_html #comment_div .comment_label .selected{background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
    ...
    #<?php echo $module['module_name'];?> .buyer .point{  display:inline-block; width:6px; vertical-align:top; overflow:hidden; color: <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
    #<?php echo $module['module_name'];?> .buyer .point:after {
	font: normal normal normal 24px/1 FontAwesome;
	content: "\f0d9";}
    #<?php echo $module['module_name'];?> .buyer .content{ display:inline-block; vertical-align:top; padding-left:10px;  padding-right:10px; border-radius:5px;  font-size:1rem;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
	...
	#<?php echo $module['module_name'];?>_html #sold_div .sold_title{ height:3rem; line-height:3rem;   padding-left:2%; width:100%; font-size:1.2rem;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>; }
	...
	#<?php echo $module['module_name'];?>_html .position{ display:none;  border-bottom:2px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;font-weight:bold;padding-left:15px;  margin-bottom:10px; margin-top:5px;  margin:auto;}
	...
	#<?php echo $module['module_name'];?>_html .transaction_progress .end:before{
		font: normal normal normal 45px/1 jzdc;
		margin-left:10px;
		margin-right:10px;
		line-height:60px;
		content: "\f005";
	...
	.goods_bottom_div a{ display:inline-block; width:78%; vertical-align:top;  text-align:center;}
	.goods_bottom_div .talk{width:11.1%; line-height:1.5rem; margin-top:0.8rem;  font-size:0.8rem;color: #999 !important;}
	.goods_bottom_div .talk:before{ display:block; font: normal normal normal 1rem/1 FontAwesome; content:"\f1d6";}
	.goods_bottom_div .enter_store{width:20%; line-height:1.5rem; margin-top:0.8rem; font-size:0.8rem;color: #999 !important;}
	.goods_bottom_div .enter_store:before{ display:block; font: normal normal normal 1rem/1 FontAwesome; content:"\f187";}
	.goods_bottom_div .favorite{width:20%; line-height:1.5rem; margin-top:0.8rem; font-size:0.8rem;color: #999 !important;}
    .goods_bottom_div .favorite2{width:20%; line-height:1.5rem; margin-top:0.8rem; font-size:0.8rem;color: #999 !important;}
	.goods_bottom_div .favorite2:before{ display:block; font: normal normal normal 1rem/1 FontAwesome; content:"\f005";}
    .goods_bottom_div .favorite2{ border-left:1px solid #e4e4e4 ;}
	.goods_bottom_div .enter_store{ border-left:1px solid #e4e4e4;}
	.goods_bottom_div .favorite{ border-left:1px solid #e4e4e4 ;}
	.goods_bottom_div .add_cart{background:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_2_hover']['text']?> !important;  }
	...
	.goods_option_div .goods_content div .price{color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; }
	.goods_option_div .goods_content div .price:before{ font: normal normal normal 1rem/1 FontAwesome; content:"<?php echo self::$language['money_symbol'];?>"; padding-right:2px;}	
	...
	.goods_option_div .specifications .color_option .selected{border:2px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
	...
	.goods_option_div .specifications .option_option .selected{ border:2px solid <?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>;}
	...
	.shop_info .a_div a{ text-align:center; display:inline-block; vertical-align:top; width:40%; margin-right:6%;    border-radius:3px;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?> !important;  }
	.cart_state{ color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?> !important; white-space:nowrap; text-align:left; padding-left:0.5rem;}
	.cart_state a{ color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?> !important;}

    <?php echo $module['favorite_css'];?>
    ...
    <div id="<?php echo $module['module_name'];?>_html">
        <div class=goods_option_div>
            ...
            <div class=quantity_div><span class=quantity_label><?php echo self::$language['quantity'];?></span><div class="quantity_value"><a href="#" class=decrease_quantity title="-1"> </a>
                    <input type="text" id=quantity value="1" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"/>
                    <a href="#" class=add_quantity title="+1"> </a><span class=unit><?php echo $module['unit'];?></span><?php echo $module['data']['limit']?></div></div>
       		<div id=s_select_state><span class="default"><span> </span></span></div>
        </div>
    
		<div class=goods_bottom_div>
            <?php echo $module['favorite'];?>
            <a href="./index.php?jzdc=mall.confirm_order&goods_src=goods_id&id=<?php echo $_GET['id']?>" rel="nofollow" id=submit class=buy_now><?php echo self::$language['buy_now']?></a>
        </div>
	...
	.swiper-active-switch {
	  background: #fff;
        ...
        <script>
            $(document).ready(function(){
                $(".return_last_page").click(function(){
                    window.opener=null;
                    window.open('','_self');
                    window.close();
                ...
                $(".favorite").click(function(){
                    ...
                    $.get('<?php echo $module['action_url'];?>&act=add_favorite',function(data){
                        //alert(data);
                        try{v=eval("("+data+")");}catch(exception){alert(data);}
                        if(v.info=='login'){window.location.href='./index.php?jzdc=index.login';return false;}
                        if(v.info=='upgrade'){alert("请先完成企业认证");window.location.href='./index.php?jzdc=index.user';return false;}
                        //jzdc_alert(v.info);
                        //if(v.state=='success'){jzdc_alert(v.info);}
                        //$("#<?php echo $module['module_name'];?> .add_favorite").attr('href','./index.php?jzdc=mall.my_collect');
                        if(v.state=='success'){
                            $("#<?php echo $module['module_name'];?> .favorite").html('<a href="./index.php?jzdc=mall.my_collect">已收藏</a>');
                            $("#<?php echo $module['module_name'];?> .favorite").attr("class", "favorite2");
                                                    }
    	...
    	<div id="goods_act_div">
        	<div id="act_div">
                ...
                <div id=s_select_state><span class="default"><span> 选择规格</span></span></div>
        ...
        <?php if(isset($companyRow) && $companyRow): ?>
        <div  id="goods_company_div">
          <span class="default" style="padding-left: 10px">
              <?=$companyRow['real_name']; ?>
          </span>
        </div>
        <?php endif; ?>
