<!---------------------------------------------------------------------------------------------slider_show_start-->
<div id=<?php echo $module['module_name'];?>  jzdc-module="<?php echo $module['module_name'];?>" align="center"  style="display:inline-block;height:<?php echo $module['height']?>; " jzdc_slider=1>
	<script>
