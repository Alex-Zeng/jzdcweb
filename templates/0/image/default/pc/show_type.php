...
$(document).ready(function(){
	...
	jzdc=get_param('jzdc');
	if(jzdc=='image.show_thumb' && get_param('type')!=''){
...
#<?php echo $module['module_name'];?>_html .type .image_type_deep_1 a:hover{  border-bottom:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?> 1px solid;}
