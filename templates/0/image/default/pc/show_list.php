...
#<?php echo $module['module_name'];?>_html .module_title{ display:block; font-size:1.71rem; height:4.28rem;line-height:4.28rem;  background-position:top;   padding-left:25px;  font-weight:bold;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
...
<div id="<?php echo $module['module_name'];?>_html" class="module_div_bottom_margin">
	<a href='./index.php?jzdc=image.show_thumb&type=<?php echo $module['type_id'];?>' class=module_title><?php echo $module['title'];?></a>
