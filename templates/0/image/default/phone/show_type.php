...
#<?php echo $module['module_name'];?>_html .type .parent{font-size:1.2rem; height:3.5rem;line-height:3.5rem;  background-position:top;   padding-left:25px;  font-weight:bold;background:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['jzdc_user_color_set']['nv_1_hover']['text']?>;}
