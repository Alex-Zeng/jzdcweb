...
echo ' <div id="user_position_reset" style="display:none;"><a href="index.php"><span id=user_position_icon>&nbsp;</span>'.self::$config['web']['name'].'</a><a href="index.php?jzdc=index.user">'.self::$language['user_center'].'</a><a href="index.php?jzdc=form.table_admin">'.self::$language['program_name'].'</a><a href="index.php?jzdc=form.table_admin&id='.@$_GET['id'].'">'.$r['description'].'</a><span class=text>'.self::$language[$_GET['power']].self::$language['power'].'</span></div>';	
