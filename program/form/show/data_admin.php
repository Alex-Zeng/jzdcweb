...
foreach($r as $v){
  ...
  <td class=operation_td><a href='#' onclick='return update(".$v['id'].")'  class='submit'>".self::$language['submit']."</a><a href='#' onclick='return del(".$v['id'].")'  class='del'>".self::$language['del']."</a> <span id=state_".$v['id']." class='state'></span><br class=br_none /><a href='index.php?jzdc=".$class.".data_show_detail&table_id=".$table_id."&id=".$v['id']."' target=_blank  class='view'>".self::$language['detail']."</a><a href='index.php?jzdc=".$class.".data_edit&table_id=".$table_id."&id=".$v['id']."' target=_blank class='edit'>".self::$language['edit']."</a></td>
</tr>
";	
}
