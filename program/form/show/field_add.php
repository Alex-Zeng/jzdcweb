...
echo ' <div id="user_position_reset" style="display:none;"><a href="index.php"><span id=user_position_icon>&nbsp;</span>'.self::$config['web']['name'].'</a><a href="index.php?jzdc=index.user">'.self::$language['user_center'].'</a><a href="index.php?jzdc=form.table_admin">'.self::$language['program_name'].'</a><a href="index.php?jzdc=form.table_admin&id='.$id.'">'.$r['description'].'</a><a href="index.php?jzdc=form.table_edit&id='.$id.'">'.self::$language['field'].self::$language['admin'].'</a><span class=text>'.self::$language['add'].self::$language['field'].'</span></div>';	
