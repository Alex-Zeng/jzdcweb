...
if($act=='import_im'){
	...
	foreach($ids as $id){
		...
		if(index::check_user_power($pdo,$id)){
			...
			$sql="insert into ".$pdo->sys_pre."im_addressee (`username`,`addressee`,`last_time`) values ('".$_SESSION['jzdc']['username']."','".$r['username']."','".time()."')";
...
if($act=='import_im_all'){
	...
	$r=$pdo->query($sql,2);
	foreach($r as $v){
		$sql="insert into ".$pdo->sys_pre."im_addressee (`username`,`addressee`,`last_time`) values ('".$_SESSION['jzdc']['username']."','".$v['username']."','".time()."')";
		$pdo->exec($sql);
	}
...
<form id="jzdc_form" name="jzdc_form" method="POST" action="./index.php?jzdc=index.send_wxmoney"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
		}
...
<form id="jzdc_form" name="jzdc_form" method="POST" action="./index.php?jzdc=index.site_msg"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
			}
		}
...
<form id="jzdc_form" name="jzdc_form" method="POST" action="./index.php?jzdc=index.email_msg"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
			}
		}
...
<form id="jzdc_form" name="jzdc_form" method="POST" action="./index.php?jzdc=index.phone_msg"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
			}
		}
...
<form id="jzdc_form" name="jzdc_form" method="POST" action="index.php?jzdc=index.edit_user_group"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
			}
		}
...
<form id="jzdc_form" name="jzdc_form" method="POST" action="index.php?jzdc=index.edit_user_group&group='.$_GET['group'].'"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
			}
		}
