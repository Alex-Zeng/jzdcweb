...
if($act=='submit'){
	//var_dump($_POST);
	if(self::$config['web']['wid']==''){exit("{'state':'fail','info':'<span class=fail>".self::$language['no_web_weixin']."</span> <a href=./index.php?jzdc=index.config#div_web__wid>".self::$language['set']."</a>'}");}
