...
$where="";
if($_GET['search']!=''){$where=" and (`title` like '%".$_GET['search']."%' or `diy_title` like '%".$_GET['search']."%')";}
if(@$_GET['order']==''){
...
foreach($r as $v){
	...
	<td><a href=./index.php?jzdc=".$v['url']." target='_blank'>./index.php?jzdc=".$v['url']."</a><br />./index.php?u=".$v['key']."</td>
  <td>".$v['click']."</td>
