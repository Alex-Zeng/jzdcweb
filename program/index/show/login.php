<?php
if(isset($_SESSION['jzdc']['id'])){header("location:index.php?jzdc=index.user");}
...
if(@$_SESSION['jzdc']['login_count']>3){$module['authCodeStyle']=' var authCodeStyle="block";';}else{$module['authCodeStyle']='var authCodeStyle="none";';}
