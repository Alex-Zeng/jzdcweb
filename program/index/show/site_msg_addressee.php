<?php
$module['jzdc_table_name']=self::$language['pages'][str_replace("::",".",$method)]['name'];
...
$where.=" and `addressee_state`!='3' and `addressee`='".$_SESSION['jzdc']['username']."'";
if(@$_GET['order']==''){
...
foreach($r as $v){
	...
	<td><a href='index.php?jzdc=index.site_msg_detail&id=".$v['id']."' target=_blank class=title>".$v['title']."</a></td>
