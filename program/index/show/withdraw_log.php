...
$sql="select * from ".$pdo->index_pre."withdraw where `username`='".$_SESSION['jzdc']['username']."'";
...
$sql="select sum(money) as c from ".$pdo->index_pre."withdraw where `state`=3 and `username`='".$_SESSION['jzdc']['username']."'";
