...
if($_COOKIE['jzdc_device']=='pc'){
	$module['phone_country_select']='<select class=phone_country id=phone_country name=phone_country jzdc_value='.$module['phone_country'].'>'.get_phone_country_opton(self::$language['phone_country']).'</select>';
