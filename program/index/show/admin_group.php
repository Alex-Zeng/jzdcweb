<?php
		function admin_group_get_list($pdo,$language,$parent,$module_name){
          ...
          <td><a href='index.php?jzdc=index.edit_group_parent&id=".$v['id']."' class='change_parent'>".$language['change'].$language['parent']."</a></td>
		  <td><a href='index.php?jzdc=index.group_require_info&id=".$v['id']."' class='require_info'>".$language['require_info']."</a></td>
          <td><a href='index.php?jzdc=index.view_menu&id=".$v['id']."' class='power'>".$language['power']."</a></td>
			</tr>
	";	
