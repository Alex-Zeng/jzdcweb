...
$module['module_name']=str_replace("::","_",$method);
	...
	$module['manager']=self::get_manager($pdo,$module['id'],$module['group'],$module['manager'])." <a href='index.php?jzdc=index.edit_user_group&id=".$module['id']."&group=".$module['group']."'>".self::$language['change']."</a>";
