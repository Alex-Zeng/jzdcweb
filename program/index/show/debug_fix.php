...
foreach($r as $v){
	...
	<td class=operation_td>".$edit."<a href='".self::$config['server_url'].'index.php?jzdc=server.debug_detail&id='.$v['debug_id']."'  class='view' target=_blank>".self::$language['view']."</a> <a href='#' onclick='return del(".$v['id'].")'  class='del'>".self::$language['del']."</a> <span id=state_".$v['id']." class='state'></span></td>
</tr>
";	
}
