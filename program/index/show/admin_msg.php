<?php
	...
	$v2['icon_path']="./templates/1/".$class."/".self::$config['program']['template_1']."/page_icon/".$pages[$v]['url'].".png";
		...
		$list.="<li><a href=index.php?jzdc=index.config&id=sms ><img src='./templates/1/index/".self::$config['program']['template_1']."/page_icon/index.config&id=sms.png' /><br><span>".self::$language['config_language']['sms']['this_name']."</span></a></li>";
