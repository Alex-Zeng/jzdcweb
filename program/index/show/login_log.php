...
if($_GET['id']==0){$_GET['id']=$_SESSION['jzdc']['id'];}
if($this->check_user_power($pdo,$_GET['id']) || $_SESSION['jzdc']['id']==$_GET['id']){
...
if($_GET['id']!=$_SESSION['jzdc']['id']){$module['username_display']='block';}else{$module['username_display']='none';}
