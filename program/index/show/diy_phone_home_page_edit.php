...
$module['module_name']=str_replace("::","_",$method);
	  ...
	  if(!self::$config['web']['diy_phone_home_page']){echo self::$language['turn_on_this_function'].' <a href=index.php?jzdc=index.config&id=web&#web>'.self::$language['click'].self::$language['set'].'</a>';return false;}
