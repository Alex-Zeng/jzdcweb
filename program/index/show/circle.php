...
$r=$pdo->query($sql,2);
$module['list']='<div class=circle_div><a href="./index.php?circle=0" circle=0><img src="./phone_menu_icon.png" /><span>'.self::$language['circle'].self::$language['unlimited'].'</span></a></div>';
foreach($r as $v){
	$sub='';
