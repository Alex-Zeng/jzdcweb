			...
			if(isset($map[$v['url']])){
				if($i<$one_max){
					...
					if(is_array($map[$v['url']]) && (count($map[$v['url']])>1)){
						...
						$temp='<a href="./index.php?jzdc='.$v['url'].'"><img src=./templates/1/'.$program.'/'.$template[$program].'/page_icon/'.$v['url'].'.png /><span>'.$language[$v['url']].'</span><i class="fa fa-angle-down"></i></a>';
						$temp2='';
								...
								if(is_array($v2)){
									...
									foreach($v2 as $k3=>$v3){
										...
										if(isset($language[$key3])){
											...
											$temp3.='<li pw='.$pw.'><a href="./index.php?jzdc='.$key3.'"><img src=./templates/1/'.$program.'/'.$template[$program].'/page_icon/'.$key3.'.png /><span>'.$language[$key3].'</span></a></li>';
										}
									}
									...
									if(isset($language[$key2])){
										...
										$temp2.='<li pw='.$pw.'><a href="./index.php?jzdc='.$key2.'"><img src=./templates/1/'.$program.'/'.$template[$program].'/page_icon/'.$key2.'.png /><span>'.$language[$key2].'</span><i class="fa fa-angle-right"></i></a>'.$temp3.'</li>';
									}
									...
									if(isset($language[$key2])){
										if(in_array($key2,$page_power)){$pw="1";}else{$pw='0';}
										$temp2.='<li pw='.$pw.'><a href="./index.php?jzdc='.$key2.'"><img src=./templates/1/'.$program.'/'.$template[$program].'/page_icon/'.$key2.'.png /><span>'.$language[$key2].'</span></a></li>';
									}
								}
						...
						$temp='<a  href="./index.php?jzdc='.$v['url'].'"><img src=./templates/1/'.$program.'/'.$template[$program].'/page_icon/'.$v['url'].'.png /><span>'.$language[$v['url']].'</span></a>';
					}
...
//--------------------------------------------------------------------------------------------------------------------------------more start					
					...
					if( is_array($map[$v['url']]) && (count($map[$v['url']]) >0) ){
						...
						$temp.=$temp2;	
						if(in_array($v['url'],$page_power)){$pw="1";}else{$pw='0';}
						$list[$one_max].='<li pw='.$pw.'><a href="./index.php?jzdc='.$v['url'].'"><img src=./templates/1/'.$program.'/'.$template[$program].'/page_icon/'.$v['url'].'.png /><span>'.$language[$v['url']].'</span></a><ul>'.$temp.'</ul></li>';	
					}else{
						if(in_array($v['url'],$page_power)){$pw="1";}else{$pw='0';}
						$other.='<li pw='.$pw.'><a href="./index.php?jzdc='.$v['url'].'"><img src=./templates/1/'.$program.'/'.$template[$program].'/page_icon/'.$v['url'].'.png /><span>'.$language[$v['url']].'</span></a></li>';
					}
