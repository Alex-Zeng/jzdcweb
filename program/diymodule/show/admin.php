...
$page_size=min($page_size,100);
			...
			foreach($r as $v){
			  ...
			  <td class=operation_td><a href='#' onclick='return update(".$v['id'].")'  class='submit'>".self::$language['submit']."</a> <a href='index.php?jzdc=".$class.".edit&id=".$v['id']."' class='edit'>".self::$language['edit']."</a> <a href='#' onclick='return del(".$v['id'].")'  class='del'>".self::$language['del']."</a> <span id=state_".$v['id']." class='state'></span></td>
			</tr>
	";	
			}
		...
		$module['page']=LansionDigitPage($sum,$current_page,$page_size,'#'.$module['module_name'],self::$language['page_template']);
