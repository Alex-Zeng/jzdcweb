...
echo '<div  style="display:none;" id="user_position_append"><a href="./index.php?jzdc=mall.create_card_list">'.self::$language['pages']['mall.create_card_list']['name'].'</a><span class=text>'.$r['name'].' '.self::$language['pages']['mall.create_card_detail']['name'].'</span></div>';
