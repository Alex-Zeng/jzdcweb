...
if($_GET['buy_method']=='unlogin' && !isset($_SESSION['jzdc']['username'])){$module['auth_html']='<div class=line id=authcode_div ><span class=m_label>'.self::$language['authcode'].'：</span><span class=value>
