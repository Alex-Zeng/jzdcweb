...
if(isset($_GET['group_id'])){
	...
	$name=$r['name'];
	echo '<div  style="display:none;" id="user_position_reset"><a href=./index.php?jzdc=index.user>'.self::$language['user_center'].'</a><a href=./index.php?jzdc=mall.master>'.self::$language['pages']['mall.master']['name'].'</a><a href=./index.php?jzdc=mall.interest_index>'.self::$language['pages']['mall.interest_index']['name'].'</a><a href=./index.php?jzdc=mall.interest_group>'.self::$language['pages']['mall.interest_group']['name'].'</a><a href="./index.php?jzdc=mall.interest_'.$type.'">'.$name.'</a><span class=text>'.self::$language['pages']['mall.interest_user_list']['name'].'</span></div>';
	...
	$r=$pdo->query($sql,2)->fetch(2);
	$name=$r['name'];
	echo '<div  style="display:none;" id="user_position_append"><a href="./index.php?jzdc=mall.interest_'.$type.'">'.$name.'</a><span class=text>'.self::$language['pages']['mall.interest_user_list']['name'].'</span></div>';
