...
foreach($r as $v){
	$list.="<tr id='tr_".$v['id']."'>
		<td><span class=name>".$v['name']."</span> <a href=./index.php?jzdc=mall.express_price&id=".$id."&upid=".$v['id']." class=show_sub title=".self::$language['sub']."></a></td>
...
$module['area_a_position']=get_area_a_position($pdo,$upid,'./index.php?jzdc=mall.express_price&id='.$id.'&upid=');
