...
if(!isset($_SESSION['jzdc']['username'])){header('location:./index.php?jzdc=index.login&backurl=./index.php?jzdc=mall.apply_shop');exit;}
...
if($r['state']!=''){
	switch($r['state']){
		...
		case 1:
			...
			break;	
		case 2:
			header('location:./index.php?jzdc=mall.seller');exit;
			echo '<div style="line-height:100px; text-align:center;">'.self::$language['shop_state_add_info'][$r['state']].'</div>'; return  false;
			break;	
		case 3:
			header('location:./index.php?jzdc=mall.seller');exit;
