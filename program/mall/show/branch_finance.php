...
foreach($r as $v){
	...
	$list.="<tr id='tr_".$v['id']."'>
		<td><a class=icon href=./index.php?jzdc=mall.shop_index&shop_id=".$v['id']." target=_blank><img src=./program/mall/shop_icon/".$v['id'].".png />".$v['name']."</a></td>
		</td>
		...
		<td class=operation_td><a href='./index.php?jzdc=mall.branch_finance_list&shop_id=".$v['id']."' target=_blank class='submit'>".self::$language['detail']."</a></td>
	</tr>
";	
