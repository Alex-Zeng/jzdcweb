...
foreach($r as $v){
  ...
  <a href='#' d_id=".$v['id']." class=loss>".self::$language['stocktake_end'].self::$language['loss']."</a>";
	}else{
		$act='';
	...
	<td><a href='./index.php?jzdc=mall.goods&id=".$v['goods_id']."' target=_blank class='icon'><img src='./program/mall/img_thumb/".$goods['icon']."'></a></td>
	<td><div class=title><a href='./index.php?jzdc=mall.goods&id=".$v['goods_id']."' target=_blank>".$v['title']."</a></div>
