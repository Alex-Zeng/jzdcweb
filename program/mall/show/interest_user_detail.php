...
if(!isset($_GET['show_time'])){header('location:./index.php?jzdc=mall.interest_user_detail&show_time=day');exit;}
$username=safe_str(@$_GET['username']);
$module['days']='<a href="./index.php?jzdc=mall.interest_user_detail&show_time=day&username='.$username.'" data="day">'.self::$language['this_day'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.interest_user_detail&show_time=week&username='.$username.'" data="week">'.self::$language['this_week'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.interest_user_detail&show_time=month&username='.$username.'" data="month">'.self::$language['this_month'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.interest_user_detail&show_time=year&username='.$username.'" data="year">'.self::$language['this_year'].'</a>';
