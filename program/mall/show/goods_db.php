...
foreach($r as $v){
	...
	<td><div class=title><a href='./index.php?jzdc=mall.goods&id=".$v['id']."' target=_blank>".$v['title']."</a></div><div class=type_tag><span class=type>".self::$language['mall'].self::$language['type'].": ".self::get_type_position($pdo,$v['type'])." ".$edit_type."</span><span class=shop_type>".self::$language['store'].self::$language['type'].": ".self::get_shop_type_position($pdo,$v['shop_type'])." <a href=./index.php?jzdc=mall.s_shop_type_set&c_id=".$v['id']."&id=".$v['shop_type']." class=set>&nbsp;</a></span></div>
	</td>
