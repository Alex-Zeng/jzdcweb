...
echo ' <div id="user_position_reset" style="display:none;"><a href="index.php"><span id=user_position_icon>&nbsp;</span>'.self::$config['web']['name'].'</a><a href="index.php?jzdc=index.user">'.self::$language['user_center'].'</a><a href="index.php?jzdc=mall.express">'.self::$language['pages']['mall.express']['name'].'</a><span class=text>'.$name.' '.self::$language['pages']['mall.express_layout']['name'].'</span></div>';	
