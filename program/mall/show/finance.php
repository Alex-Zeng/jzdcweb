...
if(@$_GET['shop_id']!=''){
	echo '<div  style="display:none;" id="user_position_append"><a href="./index.php?jzdc=mall.finance">'.self::$language['pages']['mall.finance']['name'].'</a><span class=text>'.$v['shop_name'].'</span></div>';
}
