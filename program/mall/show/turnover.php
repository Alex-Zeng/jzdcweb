...
if(!isset($_GET['start_time']) || !isset($_GET['end_time'])){header('location:./index.php?jzdc=mall.turnover&start_time='.$today.'&end_time='.$today.'');exit;}
...
$module['days']='<a href="./index.php?jzdc=mall.turnover&start_time='.$today.'&end_time='.$today.'">'.self::$language['today'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.turnover&start_time='.$yesterday.'&end_time='.$yesterday.'">'.self::$language['yesterday'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.turnover&start_time='.$before_yesterday.'&end_time='.$before_yesterday.'">'.self::$language['before_yesterday'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.turnover&start_time='.$days_7.'&end_time='.$today.'">'.self::$language['days_7'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.turnover&start_time='.$days_30.'&end_time='.$today.'">'.self::$language['days_30'].'</a>';
