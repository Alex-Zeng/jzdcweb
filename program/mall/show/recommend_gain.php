...
foreach($r as $v){
	...
	$list.="<tr id='tr_".$v['id']."'>
	  ...
	  <td><span class=username>".$v['buyer']."</span><span class=order_remark><a href=./index.php?jzdc=mall.m_order_admin&id=".$v['id']." target=_blank>".$v['out_id'].'</a> '.self::$language['order_postfix']."</span></td>
