...
switch($act){
	...
	case 'order_state_2':
		...
		$module['html']='<div class=express_div>
		<span class=m_label>'.self::$language['express'].'</span><span class=input><select id=express jzdc_value="'.$r['express'].'">'.get_express_option($pdo,self::$table_pre).'</select> <a href=./index.php?jzdc=mall.s_express target=_blank>'.self::$language['set'].'</a></span><br />
