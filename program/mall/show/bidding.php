...
if(isset($_GET['shop_id'])){
	...
	if($shop_id>0){
		...
		$shop_name=$r2['name'];
		echo '<div  style="display:none;" id="user_position_append"><a href="./index.php?jzdc=mall.bidding">'.self::$language['pages']['mall.bidding']['name'].'</a><span class=text>'.$shop_name.'</span></div>';
...
foreach($r as $v){
	...
	<td>".$v['click']."</td>
	<td><a href=./index.php?jzdc=mall.bidding_detail&gid=".$v['gid']." target=_blank>".$v['s_money']."</a></td>
	<td><a href=./index.php?jzdc=mall.bidding&shop_id=".$v['shop_id']." target=_blank>".$shop_name."</a></td>
</tr>
";	
}
