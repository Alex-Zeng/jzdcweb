...
function get_modules($program,$p_language,$modules){
	...
	foreach($m as $key=>$v){
		...
		if(in_array($key2,$modules)){
			...
			$url='./index.php?jzdc='.$view_page.'&edit_page_layout=true&edit_page_malllayout_view_module='.$module_name.'&#'.$module_name;
...
$r=$pdo->query($sql,2);
foreach($r as $v){
	$url='./index.php?jzdc=mall.edit_page_layout_view_module&edit_page_layout=true&edit_page_malllayout_view_module=mall_diymodule_show_'.$v['id'].'&#mall_diymodule_show_'.$v['id'];
...
$r=$pdo->query($sql,2);
foreach($r as $v){
	$url='./index.php?jzdc=mall.edit_page_layout_view_module&edit_page_layout=true&edit_page_malllayout_view_module=mall_slider_show_'.$v['id'].'&#mall_slider_show_'.$v['id'];
