...
if(intval(@$_GET['type'])==0){header('location:./index.php?jzdc=mall.goods_add_option_type&act=edit&id='.@$_GET['type'].'&goods_id='.@$_GET['id']);exit;}
...
if($module['data']['shop_id']!=SHOP_ID && !in_array('mall.m_goods_admin',$_SESSION['jzdc']['page'])){echo 'id err '; return false;}
...
echo '<div  style="display:none;" id="user_position_append"><a href="./index.php?jzdc=mall.goods_admin&id='.$id.'">'.mb_substr($module['data']['title'],0,30,'utf-8').'</a><span class=text>'.self::$language['pages']['mall.goods_edit']['name'].'</span></div>';
	...
	if(isset($_POST['option_color'])){	
	  ...
	  if(isset($_POST['option_option'])){
		  ...
		  $module['option_table']='<table cellpadding="0" cellspacing="0" id="option_table">
					  <thead><tr><td>'.self::$language['color'].'</td><td>'.$r['option_name'].'</td><td>'.self::$language['cost_price'].'<span class=require>*</span></td><td>'.self::$language['e_price'].'<span class=require>*</span></td><td>'.self::$language['w_price'].'<span class=require>*</span></td><td>'.self::$language['bar_code'].'</td><td>'.self::$language['store_code'].'</td><td>&nbsp;</td></tr></thead>
					  <tbody>
		  ...
		  $module['option_table']='<table cellpadding="0" cellspacing="0" id="option_table">
					  <thead><tr><td>'.self::$language['color'].'</td><td>'.self::$language['cost_price'].'<span class=require>*</span></td><td>'.self::$language['e_price'].'<span class=require>*</span></td><td>'.self::$language['w_price'].'<span class=require>*</span></td><td>'.self::$language['bar_code'].'</td><td>'.self::$language['store_code'].'</td><td>&nbsp;</td></tr></thead>
					  <tbody>
		...
		$r=$pdo->query($sql,2)->fetch(2);
		$module['option_table']='<table cellpadding="0" cellspacing="0" id="option_table">
					  <thead><tr><td>'.$r['option_name'].'</td><td>'.self::$language['cost_price'].'<span class=require>*</span></td><td>'.self::$language['e_price'].'<span class=require>*</span></td><td>'.self::$language['w_price'].'<span class=require>*</span></td><td>'.self::$language['bar_code'].'</td><td>'.self::$language['store_code'].'</td><td>&nbsp;</td></tr></thead>
					  <tbody>
