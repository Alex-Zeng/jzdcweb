...
foreach($r as $v){
	$list.="<tr id='tr_".$v['id']."'>
	  ...
	  <td class=operation_td><a href='#' onclick='return update(".$v['id'].")'  class='submit'>".self::$language['submit']."</a><a href='./index.php?jzdc=mall.express_layout&id=".$v['id']."'>".self::$language['composing']."</a><a href='#' onclick='return del(".$v['id'].")'  class='del'>".self::$language['del']."</a> <span id=state_".$v['id']." class='state'></span></td>
	</tr>
";	
