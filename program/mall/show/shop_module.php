...
foreach($r as $v){
	$sql_cache_a[]=$v;
	$v=de_safe_str($v);
	$list.="<a href=./index.php?jzdc=mall.shop_index&shop_id=".$v['id']." class=icon target=".$attribute['target']."><img src=./program/mall/shop_icon/".$v['id'].".png /><span>".$v['name']."</span></a>";
...
$module['title_link']='./index.php?jzdc=mall.shop_list&circle='.$attribute['circle'].'&tag='.$attribute['store_tag'];
