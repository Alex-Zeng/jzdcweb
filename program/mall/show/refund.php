...
foreach($r as $v){
	...
	foreach($r2 as $v2){
		...
		$temp.='<div class=goods id=g_'.$v2['id'].'><a href="./index.php?jzdc=mall.goods&id='.$v2['goods_id'].'" target=_blank class=icon><img src="./program/mall/order_icon/'.$v2['icon'].'" /></a><div class=title_price><div class=title><a href="./index.php?jzdc=mall.goods&id='.$v2['goods_id'].'" target=_blank >'.$v2['title'].'</a></div><div class=price><span class=g_price>'.str_replace('.00','',$v2['transaction_price'])."</span>*<span class=g_quantity>".self::format_quantity($v2['quantity']).'</span>'.$v2['unit']."=<span class=g_sum_money>".str_replace('.00','',$v2['transaction_price']*$v2['quantity']).'</span>'.self::$language['yuan'].$refund.$edit_quantity.' <input type="text"  og="'.$v2['id'].'" class="quantity" placeholder="'.self::$language['return_goods'].self::$language['quantity'].'" /></div></div></div>';
