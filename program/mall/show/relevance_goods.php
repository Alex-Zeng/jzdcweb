...
if($r['relevance_goods']==''){
	...
	$temp=array();
	foreach($r2 as $v){
		$temp[$v['id']]='<div class=goods_div id=goods_div_'.$v['id'].'><a href="./index.php?jzdc=mall.goods&id='.$v['id'].'" target=_blank class=goods_a><img src="./program/mall/img_thumb/'.$v['icon'].'" /><br />'.$v['title'].'</a><br /><a href=# class=move_to_left>&nbsp;</a><a href=# class=move_to_right>&nbsp;</a><a href=# class=delete_me>&nbsp;</a></div>';	
	}
...
echo '<div  style="display:none;" id="user_position_append"><a href="./index.php?jzdc=mall.goods_admin&id='.$goods_id.'">'.mb_substr($r['title'],0,30,'utf-8').'</a><span class=text>'.self::$language['pages']['mall.relevance_goods']['name'].'</span></div>';
