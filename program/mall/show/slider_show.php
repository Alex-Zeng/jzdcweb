<?php
if(isset($_GET['jzdc']) && $_GET['jzdc']=='mall.slider_show'){$id=intval($_GET['id']);}else{$id=intval($args[1]);}
if($id>0){
	...
	$t_path='./templates/0/'.$class.'/'.self::$config['program']['template_'.$m_require_login].'/'.$_COOKIE['jzdc_device'].'/style/'.$module['style'].'/show.php';
