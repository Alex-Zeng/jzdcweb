...
foreach($r as $v){
	$v=de_safe_str($v);
	if($v['option_enable']==0){$edit_type="<a href=./index.php?jzdc=mall.type_set&c_id=".$v['id']."&id=".$v['type']." class=set>&nbsp;</a>";}else{$edit_type='';}
	$list.="<tr id='tr_".$v['id']."'>
	...
	<td><div class=title><a href='./index.php?jzdc=mall.goods&id=".$v['id']."' target=_blank>".$v['title']."</a></div><div class=type_tag><span class=type>".self::get_type_position($pdo,$v['type'])." ".$edit_type."</span><span class=tag>".self::get_tags_name($pdo,$v['tag'])." <a href=./index.php?jzdc=mall.tag_set&c_id=".$v['id']."&id=".$v['tag']." class=set>&nbsp;</a></span></div></td>
	
  <td><a href='./index.php?jzdc=mall.goods_quantity_log&id=".$v['id']."' target=_blank class=sold>".$v['sold']."</a></td>
  <!--<td><a href='./index.php?jzdc=mall.shop&id=".$v['shop_id']."' class=position>".self::get_shop_name($pdo,$v['shop_id'])."</a></td>-->
  ...
  <td><select  name='mall_state_".$v['id']."' id='mall_state_".$v['id']."' jzdc_value='".$v['mall_state']."' class='mall_state' >".$mall_state_option."</select></td>
  <td class=operation_td>
  <a href='index.php?jzdc=".$class.".goods_edit&id=".$v['id']."&type=".$v['type']."'  target=_blank class=view>".self::$language['view']."</a><br />
