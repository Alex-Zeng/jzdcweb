...
foreach($r as $v){
	$list.="<tr id='tr_".$v['id']."'>
	  ...
	  <td><a href='index.php?jzdc=mall.interest_word&group_id=".$v['id']."' class=link>".$v['words']."</a></td>
	  <td>".$v['day']."</td>
	  <td>".$v['week']."</td>
	  <td>".$v['month']."</td>
	  <td>".$v['year']."</td>
	  <td><a href='index.php?jzdc=mall.interest_user_list&group_id=".$v['id']."' class=link>".$v['sum']."</a></td>
