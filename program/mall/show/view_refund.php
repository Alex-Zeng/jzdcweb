...
$sql="select `actual_money`,`express_cost_buyer`,`express_cost_seller`,`refund_reason`,`refund_amount`,`refund_remark`,`refund_voucher`,`shop_id`,`id`,`state` from ".self::$table_pre."order where `id`=".$id;
