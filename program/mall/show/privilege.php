...
$sql="select `shop_id`,`credits`,`group_id`,`balance` from ".self::$table_pre."shop_buyer where `username`='".$_SESSION['jzdc']['username']."'";
...
foreach($r as $v2){
	...
	$balance_act='';
	if($v2['balance']>0){$balance_act=' <a href=./index.php?jzdc=mall.money_transfer&shop_id='.$v2['shop_id'].' class=transfer>'.self::$language['transfer'].'</a>';}
	
	$list.="<tr id='tr_".$v['id']."'>
	  <td><div class=info>
	  	<div class=icon><a href=./index.php?jzdc=mall.shop_index&shop_id=".$v['id']." target=_blank><img src=./program/mall/shop_icon/".$v['id'].".png /></a></div><div class=other>
