...
if(intval(@$_GET['id'])!=0){
	...
	echo '<div  style="display:none;" id="user_position_append"><a href="./index.php?jzdc=mall.m_order_admin">'.self::$language['pages']['mall.m_order_admin']['name'].'</a><span class=text>'.$_GET['id'].'</span></div>';
}
...
$module['days']='<a href="./index.php?jzdc=mall.m_order_admin&start_time='.$today.'&end_time='.$today.'" se="'.$today.'-'.$today.'">'.self::$language['today'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.m_order_admin&start_time='.$yesterday.'&end_time='.$yesterday.'" se="'.$yesterday.'-'.$yesterday.'">'.self::$language['yesterday'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.m_order_admin&start_time='.$days_7.'&end_time='.$today.'" se="'.$days_7.'-'.$today.'">'.self::$language['days_7'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.m_order_admin&start_time='.$days_30.'&end_time='.$today.'" se="'.$days_30.'-'.$today.'">'.self::$language['days_30'].'</a>';
...
";
		...
		$list.="<div class=mall_order  id='tr_".$v['id']."'>
        	<div class=order_head><a href='./index.php?jzdc=mall.shop_index&shop_id=".$v['shop_id']."' class=shop_name target=_blank>".self::get_shop_name($pdo,$v['shop_id'])."</a><div class=order_state value='".self::$language['order_state'][$v['state']]."'>".self::$language['order_state'][$v['state']].$cancel_reason."</div>".$v['credits_remark']."</div>
