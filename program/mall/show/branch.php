...
foreach($r as $v){
	...
	$list.="<tr id='tr_".$v['id']."'>
	  ...
	  <td><select class=use_goods_db id='use_goods_db_".$v['id']."'  jzdc_value=".$v['use_goods_db']."><option value=0>".self::$language['no']."</option><option value=1>".self::$language['yes']."</option></select></td>
