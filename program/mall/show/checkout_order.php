...
$sql="select `id`,`out_id`,`actual_money`,`cashier`,`add_time`,`pay_method`,`preferential_way`,`goods_money`,`buyer`,`reference_number` from ".self::$table_pre."order where `shop_id`=".SHOP_ID." and `state`=6 and `cashier`!='jzdc'";
