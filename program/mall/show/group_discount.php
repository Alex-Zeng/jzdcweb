...
$module['jzdc_table_name']=self::$language['functions'][str_replace("::",".",$method)]['description'].'('.$r['title'].' '.self::$language['normal_price'].''.self::$language['money_symbol'].$price.' , '.self::$language['cost_price'].' '.$r['cost_price'].')';
