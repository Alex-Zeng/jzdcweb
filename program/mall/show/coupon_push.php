...
if(!isset($_GET['type']) || $_GET['type']==''){echo '<div style="line-height:500px; text-align:center;"><a type="button" class="btn btn-primary" href=./index.php?jzdc=mall.coupon_push&id='.$id.'&type=group>'.self::$language['push_group'].'</a> <a  type="button" class="btn btn-success" href=./index.php?jzdc=mall.coupon_push&id='.$id.'&type=username>'.self::$language['push_username'].'</a></div>';return false;}
