...
foreach($r as $v){
	...
	$list.="<tr id='tr_".$v['id']."'>
	<td>".$order['buyer']."</td>
	<td><a href='./index.php?jzdc=mall.order_admin&id=".$v['order_id']."' target=_blank>".$v['order_id']."</a></td>
	<td><a href='./index.php?jzdc=mall.goods&id=".$goods['goods_id']."' target=_blank>".$goods['title']." * ".self::format_quantity($goods['quantity'])."  ".self::$language['sum'].$order['actual_money'].self::$language['yuan']."</a></td>
	<td>".$v['username']."</td>
	<td>".$v['money']."</td>
