...
foreach($r as $v){
	$list.="<tr id='tr_".$v['id']."'>
		...
		<td><input type='text' name='rate_".$v['id']."' id='rate_".$v['id']."' value='".$v['rate']."'  class='rate' /> %</td>
		<td><input type='text' name='annual_rate_".$v['id']."' id='annual_rate_".$v['id']."' value='".$v['annual_rate']."'  class='annual_rate' /> %</td>
