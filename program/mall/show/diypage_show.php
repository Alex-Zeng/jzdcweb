...
if($id>0){
	...
	if($_COOKIE['jzdc_device']=='phone' && $module['phone_content']!=''){
...
$module['module_name']=str_replace("::","_",$method);
	...
	$module['position']="<span id=current_position_text>".self::$language['current_position']."</span><a href='./index.php?jzdc=mall.shop_index&shop_id=".SHOP_ID."'><span id=visitor_position_icon>&nbsp;</span>".self::$config['shop_name']."</a>".$module['title'];
