...
if(!isset($_GET['start_time']) || !isset($_GET['end_time'])){header('location:./index.php?jzdc=mall.reconciliation&start_time='.$today.'&end_time='.$today.'');exit;}
...
$module['days']='<a href="./index.php?jzdc=mall.reconciliation&start_time='.$today.'&end_time='.$today.'">'.self::$language['today'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.reconciliation&start_time='.$yesterday.'&end_time='.$yesterday.'">'.self::$language['yesterday'].'</a>';
$module['days'].='<a href="./index.php?jzdc=mall.reconciliation&start_time='.$before_yesterday.'&end_time='.$before_yesterday.'">'.self::$language['before_yesterday'].'</a>';
...
$sql="select * from ".self::$table_pre."checkout_log where `shop_id`=".SHOP_ID." and `username`='".$_SESSION['jzdc']['username']."'";
