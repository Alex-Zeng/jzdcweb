...
foreach($r as $v){
	if($v['buyer']!=''){$v['buyer']='<a href="./index.php?jzdc=mall.my_buyer&search='.urlencode($v['buyer']).'">'.$v['buyer'].'</a>';}
	if($v['order_id']!=''){$v['order_id']='<a href="./index.php?jzdc=mall.order_admin&id='.$v['order_id'].'">'.$v['order_id'].'</a>';}
	$list.="<tr id='tr_".$v['id']."'>
