...
foreach($r as $v){
	...
	<td><div class=title><a href='./index.php?jzdc=mall.goods&id=".$v['id']."' target=_blank>".$v['title']."</a></div>
  ...
  <a href='./index.php?jzdc=mall.purchase_add&id=".$v['id']."' target=_blank class=s_add>".self::$language['purchase']."</a>
  <a href='./index.php?jzdc=mall.goods_batch&id=".$v['id']."' class=log>".self::$language['log']."</a><br />
  <a href='./index.php?jzdc=mall.loss_add&id=".$v['id']."' target=_blank  class=loss>".self::$language['loss']."</a>
  <a href='./index.php?jzdc=mall.loss&id=".$v['id']."' class=log>".self::$language['log']."</a><br />
  <a href='./index.php?jzdc=mall.deduct_stock_add&id=".$v['id']."' target=_blank  class=deduct_stock>".self::$language['issue_2']."</a>
  <a href='./index.php?jzdc=mall.deduct_stock&id=".$v['id']."' class=log>".self::$language['log']."</a><br />
  <a href='./index.php?jzdc=mall.goods_quantity_log&id=".$v['id']."' class=log>".self::$language['sold_log']."</a><br />
