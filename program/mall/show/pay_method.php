...
foreach(self::$config['pay_method_sequence'] as $k=>$v){
	...
	$edit='';
	if($k=='bank_transfer'){$edit=" <a href='./index.php?jzdc=index.payment' target=_blank class=edit>".self::$language['edit']."</a>";}
	if($k=='online_payment'){$edit=" <a href='./index.php?jzdc=index.payment' target=_blank class=edit>".self::$language['edit']."</a>";}
	if($k=='cash_on_delivery'){$edit=" <a href='./index.php?jzdc=mall.pay_method#cash_on_delivery_remark' class=edit>".self::$language['edit']."</a>";}
	$list.='<tr id="tr_'.$v['id'].'">
