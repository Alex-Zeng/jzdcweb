...
foreach($r as $v){
	...
	$list.="<tr username='".$v['buyer']."'>
	  ...
	  <td ><span class=money>".$v['c']."</span> <a href=./index.php?jzdc=mall.order_admin&pay_method=credit&credit_state=0&search=".$v['buyer']." target=_blank>".self::$language['view']."</a></td>
