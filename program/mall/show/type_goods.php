...
foreach($r as $gv){
	...
	$shop_discount=$shop_discount_array[$gv['shop_id']];
		...
		$goods.="<div class=goods><a href='./index.php?jzdc=mall.goods&&id=".$gv['id']."' target=_blank class=goods_a><img src='./program/mall/img_thumb/".$gv['icon']."' /><span class=title>".de_safe_str($gv['title'])."</span></a><span class=price_span>".$w_price."/".self::get_mall_unit_name($pdo,$gv['unit'])."</span>".$buy_button."</div>";
