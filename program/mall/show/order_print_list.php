...
foreach($r as $v){
	...
	foreach($r2 as $v2){
		...
		$list2.="<div class=goods><span class=goods_id>".$v2['barcode']."</span><span class=goods_name>".$v2['title']."</span><span class=goods_price>".$o_price.$v2['price']."</span><span class=goods_quantity>".self::format_quantity($v2['quantity']).$v2['unit']."</span><span class=goods_money>".$v2['price']*$v2['quantity'].self::$language['yuan']."</span></div>";	
	}
