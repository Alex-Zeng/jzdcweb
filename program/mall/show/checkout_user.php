...
$module['months']='<a href="./index.php?jzdc=mall.checkout_user&start_time='.$day[0].'&end_time='.$day[1].'">'.$temp.self::$language['m'].'</a>';
if(!isset($_GET['start_time']) || !isset($_GET['end_time'])){header('location:./index.php?jzdc=mall.checkout_user&start_time='.$day[0].'&end_time='.$day[1].'');exit;}
