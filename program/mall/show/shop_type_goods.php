...
foreach($r as $gv){
		...
		$buy_button="<div class=button_div><a href='./index.php?jzdc=mall.goods&id=".$gv['id']."' target=_blank  class=add_cart option_enable='".$gv['option_enable']."'  s_id='".$sv['s_id']."' s_price='".$sv['s_price']."' title='".self::$language['add_cart']."'></a></div>";
		$goods.="<div class=goods><a href='./index.php?jzdc=mall.goods&shop_id=".SHOP_ID."&id=".$gv['id']."' target=_blank class=goods_a><img src='./program/mall/img_thumb/".$gv['icon']."' /><span class=title>".de_safe_str($gv['title'])."</span></a><span class=price_span>".$w_price."/".self::get_mall_unit_name($pdo,$gv['unit'])."</span>".$buy_button."</div>";
