<?php
if(@$_GET['act']=='scanpay'){
	echo '<form id="payment_form" name="payment_form" method="post" action="./index.php?jzdc=scanpay.pay&id='.$_GET['id'].'&iframe=1">
...
foreach($r as $v){
	...
	<div class=goods_icon>
		<a href='./index.php?jzdc=mall.goods&id=".$v['id']."' target=_blank class=goods_a><img src='./program/mall/img_thumb/".$v['icon']."' old='./program/mall/img_thumb/".$v['icon']."' /></a>
		...
		<a href='./index.php?jzdc=mall.goods&id=".$v['id']."' target=_blank  class=add_checkout option_enable='".$v['option_enable']."'>".self::$language['add_checkout']."</a> <span class=add_state></span>
	</div>
</div>";
