...
if($act=='go_module_template'){
	...
	if(!file_exists('./templates/'.$module[0].'/'.$program_config['program']['template_1'].'/'.$_COOKIE['jzdc_device'].'/'.$module[1].'.php')){exit('template '.self::$language['not_exist_file']);}
	header('location:./index.php?jzdc=index.template_edit_file&path='.$module[0].'/'.$program_config['program']['template_1'].'/'.$_COOKIE['jzdc_device'].'/'.$module[1].'.php&refresh=jzdc');exit;
}
