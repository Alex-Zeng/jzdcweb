...
if($act=='add'){
	...
	if(!isset($_SESSION['jzdc']['username']) && strtolower(@$_POST['authcode'])!=strtolower($_SESSION["authCode"])){
	...
	if(!isset($_SESSION['jzdc']['username'])){$username='';}else{$username=$_SESSION['jzdc']['username'];}
