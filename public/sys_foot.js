$(window).load(function(){
	...
	if(getCookie('edit_page_layout_div')=='true' && get_param('edit_page_layout_view_module')!=''){
		...
		$(".module_div").addClass('jzdc_exe_hide_module_div');
		$(".separator_line").removeClass('separator_line');	
		$(".jzdc_drag_div").css('display','none');
		$(".resize_div").css('display','none');
		//alert($("#"+get_param('edit_page_layout_view_module')).parent().html());
		$("#"+get_param('edit_page_layout_view_module')).removeClass('jzdc_exe_hide_module_div');
		$("#"+get_param('edit_page_layout_view_module')).addClass('jzdc_exe_show_module_div_1');
		//jzdc_alert($("#"+get_param('edit_page_layout_view_module')).css('width'));
		...
		function switch_css(){
			if($("#"+get_param('edit_page_layout_view_module')).attr('class')=='module_div jzdc_exe_show_module_div_1'){
				$("#"+get_param('edit_page_layout_view_module')).attr('class','module_div jzdc_exe_show_module_div_2');
			}else{
				$("#"+get_param('edit_page_layout_view_module')).attr('class','module_div jzdc_exe_show_module_div_1');
			}
		}
	}
		...
		//jzdc_alert($("#layout_inner").height()+'=='+$(window).height());
