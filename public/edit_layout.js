$(document).ready(function(){
	...
	$(".module_del").click(function(){
		...
		$(this).parent().parent().parent().attr('class','jzdc_module_div_deleted');
		return false;	
	});
	...
	$(".module_edit_quantity").each(function(index, element) {
    	module_name=$(this).parent().parent().prev().attr('id');   
		//alert(module_name);
		$(this).attr('href','index.php?jzdc=index.set_module_data_quantity&module='+module_name);
    });
	...
	$(".add_module").click(function(){
		...
		url='index.php?jzdc=index.edit_page_layout_add_module&url='+page+'&area='+area+'&params='+params;
		//alert(url);
		window.location.href=url;	
		return false;
	});	
	...
	$("#composing_selection a").click(function(){
		...
		$("#set_composing_state").load("receive.php?target=index::edit_page_layout&act=switch_composing&layout=full&jzdc="+get_param('jzdc')+'&to='+css,function(){
