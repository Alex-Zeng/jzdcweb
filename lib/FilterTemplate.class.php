...
class FilterTemplate{
	...
	static function get_match($reg,$str){
 	...
 	static function filter_code($path){
		...
		//echo get_jzdc_table_css_dir(__FILE__)
		$allow_code[]='#^(?:php)?\s*echo\s*get_jzdc_table_css_dir\s*\(__FILE__\);?\s*$#iU';
		//echo get_jzdc_table_js_dir(__FILE__)
		$allow_code[]='#^(?:php)?\s*echo\s*get_jzdc_table_js_dir\s*\(__FILE__\);?\s*$#iU';
		//echo @$_GET['id']
		...
		//jzdc_var_dump()
		$allow_code[]='#^(?:php)?\s*jzdc_var_dump\s*\(\s*self::\$language\s*\);?\s*$#iU';
		$allow_code[]='#^(?:php)?\s*jzdc_var_dump\s*\(\s*\$module\s*\);?\s*$#iU';
		$allow_code[]='#^(?:php)?\s*jzdc_var_dump\s*\(\s*\$_GET\s*\);?\s*$#iU';
		$allow_code[]='#^(?:php)?\s*jzdc_var_dump\s*\(\s*\$_POST\s*\);?\s*$#iU';
		$allow_code[]='#^(?:php)?\s*jzdc_var_dump\s*\(\s*\$_COOKIE\s*\);?\s*$#iU';
