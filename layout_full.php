...
<meta name="generator" content="琅讯Lansion" />
<meta name="author" content="琅讯Lansion Team" />
...
wx.ready(function(){							
	wx.onMenuShareTimeline({
		title: $('title').html(), 
		link: window.location.href+'#&share='+getCookie('jzdc_id')+'&', 
...
$(document).ready(function(){
	if(getCookie('jzdc_device')=='phone' && ($(window).width()>$(window).height()) ){
...
<!--BEGIN HEADER -->
<div class="page-header" jzdc_layout="head" user_color='head'>
...
<div class="page-container" user_color='container'>
   <div class="page-content">
	    <div class="container" jzdc_layout="full" m_container="m_container"> 
...
<!-- END PAGE CONTAINER -->
<!-- BEGIN FOOTER -->
<div class="page-footer" jzdc_layout="bottom" user_color='shape_bottom'>
...
<!-- END FOOTER -->
	 <div class=fixed_right_div >
		...
		<?php echo de_safe_str(file_get_contents('./program/index/right_buttons_'.$_COOKIE['jzdc_device'].'_data.txt'));?>
	 </div>
     <audio id="notice_audio" autoplay></audio>
     <p id=fade_div>
		 <p id=set_jzdc_iframe_div>
			<a href=# id=close_button  title="<?php echo C_CLOSE;?>">&nbsp;</a>
			<iframe  id=jzdc_iframe frameborder=0 src='' scrolling="yes" marginwidth=0 marginheight=0 vspace=0 hspace=0 allowtransparency=true></iframe>
		</p>
	 </p>
